define(function (require, exports, module) {
    ...
    var app = new Vue({
        ...
        methods:{
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data.send_count >= 5) {
                                $(".valite-phone-code button").click(function(){
                                    window.location.href = "/member/upmobile/seep6"
                                })
                            }
            ...
            getSendCount:function(count) {
                ...
                //if (count >= 5) window.location.href = ""  
            },
    ...
    module.exports = {
        initSendCount:function(SuccessUrl,ErrorUrl,CheckPhoneUrl){
            //app.sendCount = count;
