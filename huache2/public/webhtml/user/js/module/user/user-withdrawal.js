                    ...
                    $.ajax({
                        ...
                        error: function(XMLHttpRequest, textStatus, errorThrown) {
                            ...
                            if (XMLHttpRequest.responseJSON.message)
                                app.error_msg = XMLHttpRequest.responseJSON.message+',申请失败!';
                            else
                                app.error_msg = 'ERROR_CODE:' + XMLHttpRequest.status
                            setTimeout(function() {
                                app.isCodeError = !1
                            }, 3000)
                        }
