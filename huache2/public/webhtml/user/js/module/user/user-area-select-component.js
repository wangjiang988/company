define(function (require, exports, module) {
  ...
  Vue.component("province-city", {
        props:["defValue","isSelectProvince","provinceTmp","cityTmp","type"],
        template: `
        ...
        methods: {
            initProvince:function(){
                ...
                var _this = this
                $.getJSON(this.type ? '/js/vendor/front-area_all.js':'/js/vendor/front-area.js', function(json, textStatus) {
                  _this.provinceList = []
