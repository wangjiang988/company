            ...
            getVouchersList:function(){
                ...
                $.ajax({
                     ...
                     success: function(data){
                         console.log(data)
                         _this.vouchersList = data.list.data
                         _this.pageinfo.allPage =  data.total_page
                         _this.pageinfo.current =  data.list.current_page
                     },
                     error: function(){
                         // _this.vouchersList = [
