define(function (require, exports, module) {
    ...
    var app = new Vue({
        ...
        data: {
            ...
            fileList:[
                {display:!0,filename:"",del:!1},
                {display:!1,filename:"",del:!1},
                {display:!1,filename:"",del:!1},
                {display:!1,filename:"",del:!1},
                {display:!1,filename:"",del:!1},
                {display:!1,filename:"",del:!1},
        ...
        ,
        methods:{
            loadFileName:function(event,index){
                this.fileList[index].filename = event.target.files[0].name
                this.fileList[index].display = !1
                $.each(this.fileList,function(idx,item){
                    if (index != idx && !item.display && item.filename == "") {
                        item.display = !0
                        item.del = !1
                        return !1
                    }
            ...
            delFile:function(event,index){
                $(event.target).parent().find("input[type='file']").get(0).value = ""
                this.fileList[index].filename = ""
                this.fileList[index].display = !1
                this.fileList[index].del = !0 
            },
            send:function(event){
                var _this = this
