define(function (require, exports, module) {
    ...
    var app = new Vue({
        ...
        data: {
            ...
            search:{
                ...
                option:{
                    ...
                    //上牌用途列表
                    registrationApplicationList:[{txt:"\u975e\u8425\u4e1a\u4e2a\u4eba\u5ba2\u8f66",isSelect:!0,id:0},{txt:'\u975e\u8425\u4e1a\u4f01\u4e1a\u5ba2\u8f66',isSelect:!1,id:1}],
                    //交车周期列表
                    carCycleList:[{txt:"\u4e0d\u9650",isSelect:!0,id:0},{txt:'1\u4e2a\u6708',isSelect:!1,id:1},{txt:'3\u4e2a\u6708',isSelect:!1,id:3},{txt:'6\u4e2a\u6708',isSelect:!1,id:6}],
                    //是否现车
                    xianCartList:[{txt:"\u4e0d\u9650",isSelect:!0,id:0},{txt:'\u73b0\u8f66',isSelect:!1,id:1},{txt:'\u975e\u73b0\u8f66',isSelect:!1,id:2}]
        ...
        mounted:function(){
             ...
             //console.log($.support.opacity,$.support.style,window.XMLHttpRequest)
        }
        , 
        methods:{
            toLogin:function(event){
                $(".login-link")[0].click()
                Vue.config.optionMergeStrategies.rejecturl = function (){
            ...
            orderList:function(tag,event){
                ...
                switch(tag){
                    case "def"   : this.search.order.orderBy = "def"            ;break;
                    case "price" : this.search.order.orderBy = "price"          ;break;
                    case "km"    : this.search.order.orderBy = "mileage"        ;break;
                    case "time"  : this.search.order.orderBy = "factory_date"   ;break;
                    case "cycle" : this.search.order.orderBy = "term"           ;break;
            ...
            resetSearch:function(){
                ...
                //重置现车非现车
                this.search.option.xianCart="0"
                this.setListToDefaultValue(this.search.option.xianCartList)
                //重置分页组件的当前页数
                this.pageinfo.current = 1
                //重置已经选好的筛选条件
                ...
                this.search.option.isSelectXianCart = !1
            },
            //重置搜索条件
            ...
            setClass:function(d,index){
                if(typeof(index) == undefined || index == 0){
                    ...
                    $.each(app.search.option.xianCartList,function(index,item){
                        item.isSelect = !1
                    })
                }
                if(d) d.isSelect = !0 
            ...
            setOptionVal:function(index,value){
                ...
                if(index === 7) this.search.option.xianCart = value
                this.setCanSearch()    
            ...
            selectNowCar:function(d){

                $.each(this.search.option.xianCartList,function(index,item){
                    item.isSelect = !1
                })
                if(d) {
                    d.isSelect = !0
                    this.search.option.xianCarId = d.id
                    this.search.option.xianCart  = d.txt
                }
                this.setCanSearch()
            },
            //初始化特定地区
            ...
            getSearchListWithOption:function(){
                ...
                if (this.search.option.xianCarId.toString() != "0") {
                    $.extend(true, _opt, {xian_che:this.search.option.xianCarId})
                }
                ...
                else if (this.search.order.orderBy === "price") {
                    $.extend(true, _opt, {order:'price',sort:'asc'})
                }
                else if (this.search.order.orderBy === "mileage") {
                    $.extend(true, _opt, {order:'mileage',sort:'asc'})
                }
                else if (this.search.order.orderBy === "factory_date") {
                    $.extend(true, _opt, {order:'factory_date',sort:'asc'})
                }
                else if (this.search.order.orderBy === "term") {
                    $.extend(true, _opt, {order:'term',sort:'asc'})
                }
            ...
            setListData:function(_param,isSetSearchOption){
                ...
                $.ajax({
                     ...
                     dataType: "json",
                     beforeSend:function(){
                        //$(".loading").css({top:$(".search-select-option").offset().top + "px"})
                        _this.isLoading = !0
                     ...
                     success: function(data){
                        ...
                        if (isSetSearchOption) {
                            ...
                            if (_interior_color) {
                                ...
                                //兼容IE78
                                _interior_color.push($.extend({}, _limit))
                                _interior_color.reverse()
            ...
            initData:function(obj){
                ...
                this.search.mainOption.configuration.href = obj.detailImage
                //间隔200毫秒根据初始化的数据做查询
                /*setTimeout(function(){
                    app.getSearchList()
                },200)*/
    ...
    $(window).scroll(function(event){
        ...
        //thead元素移除style属性
        if (app.search.searchList.length <= 2) return
