...
define(function (require, exports, module) {
    ...
    var app = new Vue({
        ...
        methods:{
            send:function(event){
                ...
                //console.log(this.hasBuy,this.isValite,_flag,this.isPhone,this.isSelectModel,this.isInput )
                if(_flag) {
    ...
    module.exports = {
        ...
        initValiteOption : function(hasBuy,isValite){
            app.hasBuy   = hasBuy   == 0 ? !1 : !0 ;
            app.isValite = isValite == 0 ? !1 : !0 ;
            console.log(hasBuy,isValite)
        },
