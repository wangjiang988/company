define(function (require) {
    ...
    var vm = avalon.define({
        ...
        uploadcount:0,
        init: function () {
            $("#payprice").attr('placeholder', config.priceScope);
        },
        selectPayMethod: function (name) {
            $(this).find("span").addClass("selectpay").end().siblings('li').find("span").removeClass('selectpay');
            $("#payType").val(name);
        ...
        subPayForm: function () {
            ...
            if ($.trim($("#payType").val()) == "") {
                ...
                _input.attr("placeholder","请填写金额，范围"+config.priceScope);
            ...
            }else if(parseInt(_input.val()) < 1) {
                _input.focus()
                $(".inputerror:eq(2)").removeClass('hide').show()
                setTimeout(function(){
                    $(".inputerror:eq(2)").fadeOut(300)
                },3000)
            }else{
        ...
        SendCode:function(tel){
            ...
            $.post(config.sendCodeUrl, {'mobile':tel}, function (data) {
                ...
                //console.log(data)
                if (_error_code == 1) {
                    _this.next().next().removeClass("hide").text(_error_msg)
                    return false
                }
        ...
        applyExtension:function(msg){
            //span-shixie
            $(this).addClass('btn-link-bg').text('\u5df2\u7533\u8bf7')
        ...
        uploadForMuliteFileInput:function(){
            ...
            var _payprice = pzform.find("#payprice")
