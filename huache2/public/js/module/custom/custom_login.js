    ...
    var app = new Vue({
        ...
        methods:{
            ...
            customlogin:function(event){
                ...
                if ($.trim(_name.val()) == "") {
                    _flag  = false
                    this.showhidetip(_error,"\u8bf7\u8f93\u5165\u7528\u6237\u540d")
                }
                else if ($.trim(_pwd.val()) == "") {
                    _flag  = false
                    this.showhidetip(_error,"\u8bf7\u8f93\u5165\u5bc6\u7801")
                }
                else if ($.trim(_code.val()) == "") {
                    _flag  = false
                    this.showhidetip(_error,"\u8bf7\u8f93\u5165\u9a8c\u8bc1\u7801")
                }
                    ...
                    $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (_error_code == 0 || _error_code == 2 || _error_code == 3) {
                                    _flag  = false
                                    app.showhidetip(_error,_error_msg)
                                } 
            ...
            customphonevalite:function(){
                ...
                /*if ($.trim(_valite.val()) == "") {
                    this.showhidetip(_error,"\u8bf7\u8f93\u5165\u624b\u673a\u9a8c\u8bc1\u7801")
                    return
                }*/
                ...
                $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (_error_code == 0) {
                                this.showhidetip(_error,_error_msg)
                                return 
                            }
                            var _$time = 60
                            var _stxt = _this.attr("data-s")
