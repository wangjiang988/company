...
@section('content')
    ...
    @include('cart.branch.shellfragment')
            ...
            <hr class="dashed">
            <div class="clear"></div>
            <p class="fs14">根据华车平台规则，经销商方面提出修改订单，您已获得歉意金补偿人民币499.00元（在您的可用账户里了）！该金额您可在华车平台继续购车时使用，如不买也可在《我的华车》中申请全额提现。</p>
            <p class="fs14">请您选择：</p>
              ...
              <table class="tbl2">
                <form action="{{route('cart.status',['type'=>'subscribe','order_sn'=>$order['id']])}}" method="post" id="sellback">
                  ...
                  <tr>
                    ...
                    <td valign="top" class="nopadding"><p class="fs14">您不接受上述修改，很遗憾您将放弃此次订单，但您的诚意金人民币499.00元将毫发无损退回您的可用余额，供您下回购车使用（不买车可在【我的华车】中办理全额提现）。</p></td>
                  </tr>

                </table>

                <p class="fs14">
                    <span>温馨提示：请在20分钟内选择，超过时间未选，平台将默认按照放弃订单操作。</span>
                    <p class="tac red hide" id="showhide">请选择是否继续订单！</p>
                    <br><br><br>
                    <div class="time">
                        <div class="jishi jishi2 countdown">
                            <span>0</span>
                            <span>0</span>
