                            ...
                            <tr>
                                <td width="660">
                                    <table class="tbl2" width="100%">
                                        ...
                                        <tr>
                                            <td width="33%"><p><b>行驶里程：</b>{{$editcarinfo['licheng']}} 公里</p></td>
                                            ...
                                            <td colspan="3">
                                                ...
                                                <table class="tbl tbl3">
                                                   ...
                                                   foreach ($xzj as $key => $value): ?>
                                                       ...
                                                       <td>{{$value['xzj_model']}} /{{$value['xzj_notice']}}</td>
                                                ...
                                                <h2 class="text-right pr150 fs15"><b>合计价值：</b><span class="juhuang">{{$total}} 元</span></h2>
