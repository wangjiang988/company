        ...
        <div class="wapper has-min-step">
            ...
            <div class="box">
                ...
                <div class="box-inner  box-inner-def">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="times times2" style="height:450px">
                                        ...
                                        <p class="pl20 lh25"><b>客户车辆用途：   </b>{{carUse($order['buytype'])}} </p>
                                        <p class="pl20 pt">{{$jxs['d_shi']}}
                                          <b>上牌车主身份类别： </b>
                            ...
                            <tr>
                                <td width="660">
                                    <table class="tbl2" width="100%">
                                        ...
                                        <tr>
                                            <td colspan="3"><p><b>行驶里程：</b>{{ $bj['bj_licheng'] }} 公里</p></td>
                                            ...
                                            <td colspan="3">
                                                ...
                                                <table class="tbl tbl3">
                                                   ...
                                                   <tr>
                                                       ...
                                                       <td><?php echo $value['xzj_model'];?><?php echo isset($value['beizhu'])?'/'.$value['beizhu']:'' ; ; ?></td>
                            ...
                            <tr>
                                <td width="660">
                                    <table class="tbl2" width="100%">
                                        ...
                                        <tr>
                                            <td><p><b>车辆识别代码（VIN码）：</b></p></td>
                                            <td width="50%" colspan="2"><p class="ml150"><b>发动机号：  </b></p></td>
                                        </tr>
                                        <tr>
                                            <td><p><b>实车出厂年月：</b></p></td>
                                            <td width="50%" colspan="2"><p class="ml150"><b>实车行驶里程：  </b></p></td>
                                        </tr>
                                    </table>                                    
                                </td>
                            </tr> 
                    ...
                    <p class="fs14 tar pr80"><b>合计：</b></p>
...
<h2 class="title">车辆首年商业保险</h2>
                  ...
                  <p class="fs14"><b>客户确定由经销商代办上牌手续。 </b></p>
                    ...
                    <p class="fs14 pl20">注：文件数量标记“√”表示文件为正本或原件，不同环节可通用。</p>
                      ...
                      <form action="{{ url('dealer/ticheinfo') }}" method="post" name="item-form">
                          <?php if ($order['shangpai']): ?>
                            <div style="width: 70%;margin:0 auto">
                               <table class="tbl2">
                                  <tbody>
