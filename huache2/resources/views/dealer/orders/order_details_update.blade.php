        ...
        <div class="wapper has-min-step">
            <div class="box">
                <div class="box-inner  box-inner-def">
                    ...
                    @endforeach
                    @endif
                    @if(count($car['editcarinfo'])>0 ||count($car['editxzj'])>0 || count($car['editzengpin'])>0)
                        <h2 class="title"><span class="ml5"><b>提议修改内容</b></span></h2>
                        <table class="tbl tbl-blue wp100">
                            <tr>
                                <th><p class="tac fs14"><b>项目</b></p></th>
                                <th><p class="tac fs14"><b>原约定</b></p></th>
                                <th><p class="tac fs14"><b>现改为</b></p></th>
                            </tr>
                            @foreach($car['editcarinfo'] as $key=>$info)
                            @if($key == 'body_color')
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><p class="tac fs14">{{$car_info['nside_color']}}</p></td>
                                <td><p class="tac fs14">{{$info}}</p></td>
                            </tr>
                            @endif
                            @if($key == 'year_month')
                            ...
                            <tr>
                                ...
                                <td><p class="tac fs14">@if(!$car_info['paifang'])
                                            国五
                                            @else
                                            国四
                                            @endif</p></td>
