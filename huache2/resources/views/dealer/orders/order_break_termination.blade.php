                  ...
                  @include('dealer.orders._layout.order_negotiation')
                    <table class="tbl">
                        <tbody>
                            ...
                            <tr>
                            <?php $arr = [config('orders.order_sincerity_member_invasion'),
                            ...
                            <td colspan="2" class="tal"><p class="fs14"><b>结束原因：</b>客户原因—裁判客户违约</p></td>
                            @else
                            <td colspan="2" class="tal"><p class="fs14"><b>结束原因：</b>客户原因—裁判售方违约</p></td>
                            @endif
                            </tr>
                            <tr>
                                <td class="tal fs14 norightborder" valign="top" width="100"><b>当前执行：</b></td>
                                <td class="noleftborder">
                                <?php $price = $order->limitConciliation();?>
