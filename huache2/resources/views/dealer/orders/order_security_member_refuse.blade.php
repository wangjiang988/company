...
@section('title', '客户不接受修改而结束订单-用户管理-华车网')
@section('content')
                ...
                @include('dealer.orders._layout.content_cancel')
                    <table class="tbl">
                        <tbody>
                            ...
                            <tr>
                                <td colspan="2" class="tal"><p class="fs14"><b>结束原因：</b>售方原因—售方修改，客户不接受</p></td>
                            </tr>
                            <tr>
                                <td class="tal fs14 norightborder" valign="top" width="100"><b>当前执行：</b></td>
                                <td class="noleftborder">
                                   <p>1.华车平台损失赔偿￥588.00</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
@section('js')
    ...
    <script type="text/javascript">
        seajs.use(["/webhtml/common/js/vendor/vue.min","module/custom/custom-order-base", "module/common/common"],function(v,u,c){
