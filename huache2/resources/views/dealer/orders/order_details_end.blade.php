...
@section('title', '诚意金阶段主动终止-用户管理-华车网')
@section('content')
                            ...
                            <tr>
                                <td width="660">
                                    <table class="tbl2" width="100%">
                                        ...
                                        <?php $baojia = $order->orderBaojia; ?>
                                            ...
                                            <td><p><b>结束时间:</b></p>{{date('Y年m月d日',strtotime($order->updated_at))}}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                              <p>
                                        ...
                                        <tr>
                                            <td><p><b>数量：</b>1台</p></td>
                                            <td><p><b>内部车辆编号：</b>{{$baojia['bj_dealer_internal_id']}}</p></td>
                                        </tr>
                                ...
                                <td>
                                    <div class="times times-error">
                                        <p class="status tac  m-t-10"><b class="fs14">订单状态：售方主动终止</b></p>
