...
@section('title', '客户不接受修改而终止-用户管理-华车网')
@section('content')
                ...
                <div class="box-inner  box-inner-def">
                                    ...
                                    <table class="tbl2" width="100%">
                                        <tr>
                                            <td  width="50%"><p><b>订单号：</b>{{$order['order_sn']}}</p></td>
                                             <td  width="50%"> <b>订单时间：</b>{{$order['created_at']}}
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <?php $price = $order->orderPrice;?>
                                        <tr>
                                            <td colspan="2"><p><b>车辆开票价格：</b>￥{{number_format($price['car_price'],2)}}</p></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"><p><b>客户买车定金：</b>￥{{number_format($price['client_hand_price'],2)}}</p></td>
                                        </tr>

                                         <tr>
                                             <td><p><b>我的服务费：</b>￥{{number_format($price['agent_service_price'],2)}}</p></td>
                                        </tr>
                    ...
                    <table class="tbl">
                        <tbody>
                            ...
                            <tr>
                                <th class="tal juhuang"><label class="weight fs16">交易结果</label></th>
                            </tr>
                            <tr>
                                <td class="tal"><p class="fs14"><b>结束原因：</b>售方原因—售方修改，客户不接受</p></td>
                            </tr>
                            <tr>
                                <td class="tal fs14 norightborder" valign="top" width=""><p><b>当前执行：</b>1.华车平台损失赔偿￥200.00 </p></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="tbl">
                       ...
                       <tr>
                            <td rowspan="3"><p class="tac fs14"><b>总收益</b></p></td>
                            <td rowspan="3"><p class="tac fs14"><b>- ￥699.00</b></p></td>
                        ...
                        <tr>
                            ...
                            <td><p class="tac fs14">- ￥200.00</p></td>
                            <td><p class="tac fs14"></p></td>
                            <td><p class="tac fs14">2017-02-23 15：41：18</p></td>
                        </tr>
                        <tr>
