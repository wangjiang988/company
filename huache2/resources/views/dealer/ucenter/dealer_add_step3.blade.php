...
@section('content')
                    ...
                    <div class="content-wapper ">
                       ...
                       <form action="/dealer/ajaxsubmitdealer/next-step/{{$dealer_id}}" name="next-form">
                         <!--1==true ? '' :'<div class="tbl-list-tool-panle valite-xx hide">
                                                    <p><b>上牌（车辆注册登记）：</b></p>
                         ...
                         <div class="ml20">
                            <p class="fs14"><b>上牌（车辆注册登记）：</b>本地客户自由办理，异地客户本人办理</p>
                            <div class="m-t-10"></div>
                            <p class="fs14">
                                <b>代办上牌服务费金额  </b>
                                <span class="ml10">￥</span>
                                <input name="dl_shangpai_fee" maxlength="8" type="text" class="ml10 form-control w150 inline-block positive-integer">
                                <span class="error-info error-div juhuang fs14">*请输入数字格式，且须为100的整数倍，例如100</span>
                       ...
                       @else
                         ...
                         <div class="ml20">
                            ...
                            <p class="fs14">
                                <b>代办上牌服务费金额  </b>
                                <span class="ml10">￥</span>
                                <input value="{{$daili['dl_shangpai_fee']}}" name="dl_shangpai_fee" maxlength="8" type="text" class="ml10 form-control w150 inline-block positive-integer">
                                <span class="error-info error-div juhuang fs14">*请输入数字格式，且须为100的整数倍，例如100</span>
                                <span class="error-info error-div ml10 gray-info fs14">请输入100的整数倍的数字</span>
                            </p>
                         </div>
...
@section('js')
	 <script type="text/javascript">
        seajs.use(["module/custom/custom-step3", "module/common/common", "bt"],function(a,b,c){
