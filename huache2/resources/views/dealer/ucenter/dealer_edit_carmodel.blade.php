                        ...
                        <div class="content-wapper ">
                               ...
                               @endforeach
                                 ...
                                 @foreach ($new_yc as $y)
                                     <tr>
                                         ...
                                         <td class="tac"><span>{{$y->xzj_model}}</span></td>
                                         <td class="tac">
                                             <input class="text-center card-input card-txt-price" type="text" name="qza_cs_serial[{{$y->id}}]" id="" value="">
                                             <div class="error-div"><label>请输入厂商编号</label></div>
                                         </td>
                                         <td class="tac"><span>￥{{$y->xzj_guide_price}}</span></td>
                                         <td class="tac"><span>{{$y->xzj_max_num}}</span></td>
                           ...
                           <table class="tbl custom-info-tbl tbl-after">
                             <tbody>
                               ...
                               @if(count($fyc)>0 || count($new_fyc)>0)
                                @foreach ($fyc as $f)
                               <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tac">
                                            <input
                                                    ...
                                                    placeholder=""
                                            @endif
                                            " class="text-center card-input card-txt-price" type="text" name="hza_cs_serial[{{$f->id}}]" id=""
                                            @if(isset($f->xzj_cs_serial))
                                                value="{{$f->xzj_cs_serial}}"
                                            @else
                                                value=""
                                            @endif
                                            >
                                        ...
                                        <td class="tac">
                                            ￥<input
                                                    ...
                                                    placeholder=""
                                            @endif
                                            " class="text-center card-input card-txt-price valite money-valite" type="text" name="xzja_fee[{{$f->id}}]" id=""
                                            @if(isset($f->xzj_fee))
                                                value="{{$f->xzj_fee}}"
                                            @else
                                                value="0"
                                        ...
                                        <td class="tac">
                                            <div class="btn-group ">
                                                ...
                                                <input type="hidden" name="xzja_has_num[{{$f->id}}]" value="
                                            @if(isset($f->xzj_has_num))
                                                {{$f->xzj_has_num}}
                                                @else
                                                @endif">
