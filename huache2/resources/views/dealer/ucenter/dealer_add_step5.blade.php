...
@section('content')
                     <div class="custom-set-flow-step-wrapper">
                         <ul class="custom-set-flow-step">
                             ...
                             <li class="prev"><span>临牌条件</span></li>
                             <li class="cur cur-step"><span>免费提供</span></li>
                     ...
                     <div  class="content-wapper ">
                       <div id="vue">
                           ...
                           <p><b>免费礼品或服务</b><a @click="servicelAdd" href="javascript:;" class="juhuang tdu ml10 controlModelAdd">添加</a></p>
                           ...
                           <p class="tac">
                              <a href="javascript:;" @click="nextAction(6)" class="btn btn-danger fs18">下一步</a>
                              <a href="/dealer/editdealer/check/{{$id}}/step4"  class="juhuang tdu ml5"><span>返回上一步</span></a>
                           </p>
                            <p class="tac">
                           ...
                           <table class="hide" id="service-tmpl">  
