...
@section('content')
                     <div class="custom-set-flow-step-wrapper">
                         <ul class="custom-set-flow-step">
                             ...
                             <li class="prev"><span>免费提供</span></li>
                             <li class="cur cur-step"><span>杂费标准</span></li>
                     ...
                     <div class="content-wapper ">
                       <div id="vue">
                           ...
                           <form name="next-form" method="post" action="/dealer/ajaxsubmitdealer/next-step/{{$dealer_id}}">
                               <p class="tac">
                                  <a href="javascript:;" @click="nextAction(7)" class="btn btn-danger fs18">下一步</a>
                                  <a href="/dealer/editdealer/check/{{$id}}/step5"  class="juhuang tdu ml5"><span>返回上一步</span></a>
                                 </p>
                                  <p class="tac">
