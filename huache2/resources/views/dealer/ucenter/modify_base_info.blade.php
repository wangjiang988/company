...
@section('content')
             ...
             <tr>
                 ...
                 <td width="660" class="nobottomborder" style="text-align: left;">
                     ...
                     <div class="pic-wrapper">
                         <div class="pic">
                             <img ms-on-click="upload" onerror="this.src='/themes/images/custom/custom-info-head.gif'"  width="84" height="89" class="block" src="/{{$member['seller_photo']}}" alt="">
    ...
    <p class="tac">
        ...
        <a href="javascript:history.back(-1);" class="btn btn-s-md btn-danger  sure ml20 ">返回</a>
    </p> 
