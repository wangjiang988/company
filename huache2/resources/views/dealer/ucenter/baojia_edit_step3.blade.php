...
@section('content')
                    ...
                    <form action="/dealer/baojia/edit/{{$baojia['bj_id']}}/3" name="baojia-submit-form" method="post">
                        ...
                        <div class="content-wapper ">
                            ...
                            <p>
                             <span>原厂选装精品折扣率：</span>
                             <input value="{{$baojia['bj_xzj_zhekou']}}" placeholder="" type="text" name="bj_xzj_zhekou" class="form-control custom-control custom-control-min tac abs">
                             <span>%</span>
                            ...
                            <table class="tbl tbl-blue wp100" id="tpl-is-front">
                              <tbody>
                                <tr>
                                  <th width="50" class="tac"><span>选择</span></th>
                                  <th width="150" class="tac"><span>名称</span></th>
                                  <th width="150" class="tac"><span>型号/说明</span></th>
                                  <th width="60" class="tac"><span>厂商编号</span></th>
                                  <th width="80" class="tac"><span>厂商指导价</span></th>
                                  <th width="80" class="tac"><span>折后价</span></th>
                                </tr>
                                @forelse($xzj['yc'] as $k=>$v)
                                <tr>
                                  <td class="tac select-checked"><input {{isset($bj_xzj[$v->id])?"checked":''}} type="checkbox" name="xzj[]" value="{{$v->xzj_id}}" id=""></td>
                            ...
                            <table class="tbl tbl-blue wp100" id="tpl-not-front">
                              <tbody>
                                <tr>
                                  ...
                                  <th width="150" class="tac"><span>名称</span></th>
                                  <th width="150" class="tac"><span>型号/说明</span></th>
                                  <th width="50" class="tac"><span>厂商编号</span></th>
                                  <th width="80" class="tac"><span>厂商指导价</span></th>
                                  <th width="80" class="tac"><span>安装费</span></th>
                                ...
                                <tr>
                                  ...
                                  <td class="tac"><span>{{$v->xzj_cs_serial}}</span></td>
                                  <td class="tac">￥<span>{{number_format($v->xzj_guide_price,2)}}</span></td>
                                  <td class="tac">￥<span>{{number_format($v->xzj_fee,2)}}</span></td>
                                  <td class="tac">￥<span>{{number_format($baojia['bj_xzj_zhekou']*$v->xzj_guide_price/100+$v->xzj_fee,2)}}</span></td>
