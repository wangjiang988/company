...
@section('content')
                    ...
                    <div class="content-wapper ">
                        ...
                        <br /><br />
                        <p class="tac"><a href="javascript:;" ms-on-click="SendEmail('{{$member['seller_email']}}',2)" data-s="重新获取" data-send="重新获取($1)"  class="btn btn-s-md btn-danger fs16 btn-s w150">下一步</a></p>
                        <p class="tac"><a href="/dealer/changeemail/byphone" class="juhuang">使用已验证手机修改邮箱>></a></p>
