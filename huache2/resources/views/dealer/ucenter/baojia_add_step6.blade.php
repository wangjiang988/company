                        ...
                        <div class="content-wapper ">
                           ...
                           <div class="box">
                               ...
                               <label class="radio-label ml50 noweight">
                                 <input type="radio" name="fulltime" id="now_full_time" value='1' checked>
                                 <span>立即生效，始终有效
                               ...
                               <label class="radio-label ml50 noweight">
                                 <input type="radio" class="time-set" name="fulltime" id="range_full_time" value='0'>
                                 <span>按设置生效及有效时间
                               ...
                               <div class="no-offer ml50">
                                   ...
                                   <div class="btn-group m-r time-sl fl ml10">
                                      <div class="form-group psr pdi-control">
                                        <input readonly="" type="text" value="{{time()>strtotime(date('Y-m-d').' 17:00:00')?date('Y-m-d',strtotime('+1 day')):date('Y-m-d')}}" id="start_date" class="form-control select-time-control start time-input" onfocus="WdatePicker({onpicked:function(){syn_end_date();},startDate:'{{$day['start_day']->toDateString()}}',dateFmt:'yyyy-MM-dd',minDate:'%y-%M-#{%d+{{$day['start_add']}}}'});" name='start_time_1'>
                                        <i class="rili"></i>
                                      </div>
                                   </div>
                                   <div class="btn-group m-r time-sl fl ml20">
                                      <div class="form-group psr pdi-control">
                                        <input value="9:00"  data-hour="{{$day['start_hour']}}" type="text" class="form-control work-control am time-input" name='start_time_2'>
                               ...
                               <div class="no-offer ml50">
                                   ...
                                   <div class="btn-group m-r time-sl fl ml10">
                                      <div class="form-group psr pdi-control">
                                        <input readonly="" type="text" value="{{time()>strtotime(date('Y-m-d').' 17:00:00')?date('Y-m-d',strtotime('+1 day')):date('Y-m-d')}}"  id="end_date" class="form-control select-time-control start time-input" onfocus="WdatePicker({startDate:'{{$day['end_day']->toDateString()}}',dateFmt:'yyyy-MM-dd', minDate:'%y-%M-#{%d+{{$day['end_add']}}}'});" name='end_time_1'>
                                        <i class="rili"></i>
                                      </div>
                                   </div>
                                   <div class="btn-group m-r time-sl fl ml20">
                                      <div class="form-group psr pdi-control">
                                        <input value="17:00" data-hour="{{$day['end_hour']}}"  type="text"  class="form-control work-control pm time-input" name='end_time_2'>
                                        <i class="icon-times"></i>
                                      </div>
                                   </div>
                                   <div class="clear"></div>
                           ...
                           <p class="tac">
                                ...
                                <a href="javascript:;" class="btn btn-danger fs18 ml20 baojia-submit-button" data-step='6' data-type='{{$button_type}}'>提交</a>
                               ...
                               <div class="time-fn-box">
                                   ...
                                   <div class="time-show-wrapper fl">
                                       <div class="center-c">
                                           ...
                                           <span class="center-txt min" min="0" max="5" id="time-minute-str-1">0</span>
                                       </div>
                                   </div>
                                   <div class="time-show-wrapper fl ml10" >
                                       <div class="center-c">
                                           <div class="center-split  mt25"></div>
                                           <span class="center-txt bit" min="0" max="9" id="time-minute-str-2">0</span>
                                       </div>
                                   </div>
                                   <div class="clear"></div>
                               </div>
...
seajs.use(["module/custom/custom_admin",
    ...
    "module/custom/custom.admin.matters.jquery",
