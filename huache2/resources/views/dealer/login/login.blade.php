...
@section('content')
    ...
    <div class="m-t-86 pos-rlt content custom-login" >
        <div class="container">
            <div class="wapper has-min-step">
                    ...
                    <div class="login-panel">
                        ...
                        <div class="custom-login-wrapper">
                            <div class="login-input-panel">
                                ...
                                <input placeholder="用户名" type="text" name="loginname" value=''/>
                                <div class="clear"></div>
                            </div>
                            <div class="login-input-panel">
                                <label class="pwd"></label>
                                <input placeholder="密码" type="password" name="loginpwd" value=''/>
                                <div class="clear"></div>
                            </div>
                            ...
                            <input @click="customlogin" type="button" value="登录" class="btn btn-s-md btn-danger btn-custom-login">
                        ...
                        <div class="custom-phone-valite-wrapper">
                            ...
                            <input @click="customphonevalite" data-s="重新获取" data-send="重新获取($1)" type="button" value="获取手机验证码" class="btn btn-s-md btn-danger btn-custom-phone-valite">
                            <div class="clear"></div>
                            <input @click="customphonelogin" type="button" value="登录" class="btn btn-s-md btn-danger btn-custom-login">
                        </div>
                ...
                <div class="ruzhu-panel" @click="ruzhu"></div>
                <div class="clear"></div>
