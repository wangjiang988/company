    ...
    <div class="container m-t-86 pos-rlt" id="vue">
        <div class="wapper">
            <div class="hd reg-box">
                ...
                <form action="{{ route('mail.reset') }}" id="password-step-4">
                    <div class="form" >
                        <br>
                            ...
                            <tr v-cloak v-show="!isOpenEye">
                                ...
                                <td>
                                    <div class="psr inline-block">
                                        <input @blur="checkPwd2" @focus="setPwd2Status" v-model="form.pwd2" :value="form.pwd2" maxlength="20" type="password" :class="{'form-input':true,'form-input-def-long':true,'error-bg':pwd2InputStatus==2 || pwd2InputStatus==3}"/>
                        ...
                        <p class="tac">
                            <button :disabled="isLoading" @click="send" type="button" class="btn btn-s-md btn-danger w120 mt20">下一步</button>
                        </p>
...
@section('js')
    <script type="text/javascript">
        seajs.use(["vendor/vue","module/pwd/password-step-4"],function(a,b,c){
            b.initUrl("{{ route('pwd.pwdOver') }}","{{ route('pwd.pwdSuccess') }}");
            b.init('{{ $start_date }}','{{ $end_date }}','{{ $thisData }}');
        })
    </script>
@endsection