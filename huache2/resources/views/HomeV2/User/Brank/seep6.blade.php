...
@section('content')
    <div class="user-content user-content-with-margin marign-top-tab psr">
        ...
        <h2 class="blue-title pb0 psr">
            <span class="blue">更换银行账户-更换未成功</span>
        </h2>
                ...
                <table class="noborder-tbl wp100">
                    <tr>
                        ...
                        <td width="600" class="bank-area">
                            <province-city v-on:receive-params="getArea" def-value="请选择·开户地区" is-select-province="false"></province-city>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <div class="bank-card-wrapper mauto tac mt20">
                                ...
                                <div class="bank-card-item-wrapper">
                                    <img id="upload-img-hand-bank" src="{{ getImgidToImgurl($bank->sc_bank_img) }}" alt="" width="164" height="96">
                                    <p class="tac mt10">
