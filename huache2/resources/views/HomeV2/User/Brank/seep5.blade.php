...
@section('content')
    <div class="user-content user-content-with-margin marign-top-tab psr">
        ...
        <h2 class="blue-title pb0 psr">
            <span class="blue">更换银行账户-更换审核中</span>
        </h2>
        <div class="content-wapper">
            ...
            <table class="noborder-tbl wp100 ml100">
                ...
                <tr>
                    <td colspan="2">
                        <div class="bank-card-wrapper mauto mt20 ml50">
                            <div class="bank-card-item-wrapper">
                                <img id="upload-img-bank" src="{{ getImgidToImgurl($bank->bank_img) }}" alt="" width="164" height="96">
                            </div>

                            <div class="bank-card-item-wrapper">
                                <img id="upload-img-bank" src="{{ getImgidToImgurl($bank->sc_bank_img) }}" alt="" width="164" height="96">
                            </div>
                        </div>
                    </td>
                </tr>
