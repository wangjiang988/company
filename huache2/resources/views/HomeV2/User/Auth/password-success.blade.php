...
@section('content')
    <div class="user-content">
        <h4 class="blue-title"><span class="fs14">修改密码成功</span><div class="mt5"></div></h4>
        <div class="content-wapper ">
            ...
            <div class=" mt60">
                ...
                <p class="tac"><a href="{{ url('/') }}" class="btn btn-s-md btn-danger fs16 sure">确认</a></p>
...
@section('js')
    <script type="text/javascript">
        seajs.use(["/webhtml/common/js/vendor/vue.min","/webhtml/user/js/module/user/user-phone-step3"],function(v,u,c){
