...
@section('content')
    <div class="user-content">
        ...
        <div class="content-wapper ">
            ...
            {!! Form::open(['url'=>route('account.sendMail'),'role'=>'form']) !!}
            <div class=" mt60">
                ...
                <p class="tac"><a href="{{ route('upmobile.seep1') }}" class="juhuang">使用已验证手机修改验证手机号>></a></p>
            </div>
            {!! Form::close() !!}
...
@section('js')
    <script type="text/javascript">
        seajs.use(["/webhtml/common/js/vendor/vue.min","/webhtml/user/js/module/user/user-email-step1", "/webhtml/user/js/module/common/common"],function(v,u,c){
            u.init('{{ route('account.sendMail') }}','{{ route('upmobile.seep3') }}');
        })
    </script>
@endsection