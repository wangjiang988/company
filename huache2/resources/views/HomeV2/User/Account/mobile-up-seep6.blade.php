        ...
        <div class="content-wapper ">
            ...
            <div class=" mt60">
                <h1 class="success-title">
                    <table class="mauto">
                        <tr>
                            ...
                            <td><span class="inline-block ml20">对不起，本次修改手机失败！</span></td>
                        </tr>
                    </table>
                </h1>
                ...
                <p class="tac">
                    ...
                    <a href="{{ route('upmobile.seep1') }}" class="btn btn-s-md btn-danger fs16 sure ml50">重新修改</a>
                </p>
