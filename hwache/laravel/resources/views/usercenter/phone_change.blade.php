				...
				<h2 class="title">修改手机号</h2>  
                    <div class="content-wapper">
                       <div class="hd">
                        ...
                        <p class="tac"><a href="javascript:;" ms-on-click="SendEmail" data-s="重新获取" data-send="重新获取($1)"  class="btn btn-s-md btn-danger fs16 btn-s w150">下一步</a></p>
                        <p class="tac"><a href="./phone_change_by_email" class="juhuang">使用已验证邮箱修改手机号码>></a></p>
