...
@section('content')
    ...
    <div  class="container pos-rlt content" ms-controller="item">
        <div class="wapper has-min-step">
            <p>尊敬的客户：</p>
            <p class="ti">很抱歉经销商方面提出了终止订单，按平台规则，退还的诚意金人民币{{$sysprice['chengyijin']}}元，获得的歉意金补偿人民币{{$sysprice['qianyijin']}}元，均已进入您的可用账户。</p>
            <hr class="dashed">
            ...
            <p class="tal">
                <a href="/"  class="btn btn-s-md btn-danger sure">再选辆车</a>
            </p>
