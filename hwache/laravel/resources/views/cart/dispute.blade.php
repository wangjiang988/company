  ...
  <div class="container m-t-86 pos-rlt">
    ...
    <div class="container pos-rlt content" ms-controller="item">
        <div class="wapper has-min-step">
            ...
            <hr class="dashed">
            <p class="fs14">您已向华车平台提请争议处理的内容如下：</p>
            <p class="fs14"><b>1.提车中遇到的问题</b></p>
            <div class="tbl">
                <ul class="bxlist">
                <?php foreach ($problem as $key => $value): ?>
                    <li style="width: 30%">
                        <p><input checked disabled type="checkbox" class="radio"></p>
                        <dl>
                            <dt>{{$value}}</dt>
                            <div class="clear"></div>
                        </dl>
            ...
            <div class="clear"></div>
            <p class="fs14"><b>2.您的详细说明及诉求</b></p>
            <textarea class="txtarea"  readonly="readonly">{{$content}}</textarea>
            <p class="fs14"><b>3.您的证据材料</b></p>
            <div>
            <span class="blue fl ">
            <?php foreach ($evidence as $key => $value): ?>
                <span class="file-prev ml10"><a href="{{config('app.url')}}/upload/evidence/{{$value['urls']}}" target="_blank">{{$value['urls']}}</a></span>
            <?php endforeach ?>
                </span>
                <div class="clear"></div>
            </div>
            ...
            <br>
			@else
				<p class="fs14 bl5"><b class="ml10">经销商正在申辩补充说明“<span class="juhuang">{{$content}}</span>”,敬请等待......</b></p>
			@endif
            <hr class="dashed">
            ...
            <div>
				...
				@else
					<textarea class="form-control pdi-control m-t-10 w70" cols="66" rows="3" readonly>{{$dispute['dispute_hejie']}}</textarea>
