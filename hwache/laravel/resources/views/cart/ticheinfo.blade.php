  ...
  <div class="container m-t-86 pos-rlt" >
    ...
    <div class="container pos-rlt content r-pdi"  ms-controller="item">
        ...
        <div class="wapper has-min-step">
            <h1>尊敬的客户：</h1>
            <h1 class="ti">和梦想的座驾终于相逢啦！此刻的激动和喜悦，与我们一起分享吧！ </h1>
            <h1 class="ti">如果您感觉交车轻松顺利，简要填写下方内容就能告诉我们了。  而万一您遇到困扰，请<a href="{{url('cart/zhengyi')}}/{{$order_num}}" class="juhuang tdu">点此</a>，让我们为您排忧解难。</h1>
            <br>
            ...
            <p class="fs14 tac">
                ...
                <a href="{{url('orderoverview')}}/{{$order_num}}" class="juhuang tdu pl20">查看订单总详情</a>
                    ...
                    <table class="tbl">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="cell">
                                    <p class="tac fs14">
                                        <input name="guobie" checked="" class="radio" type="radio" value="1"><span>相符</span>
                                        <input name="guobie" class="radio" type="radio" value="0"><span>不相符</span>
                                    </p>
                                </td>
                                <td width="400">
                            ...
                            <tr>
                                ...
                                <td class="cell">
                                    <p class="tac fs14">
                                        <input name="peizhi" checked="" value="1" class="radio" type="radio"><span>相符</span>
                                        <input name="peizhi" class="radio" value="0" type="radio"><span>不相符</span>
                                    </p>
                                </td>
                                <td width="400">
                            ...
                            <tr>
                                ...
                                <td class="cell">
                                    <p class="tac fs14">
                                        <input name="jxs" value="1" checked="" class="radio" type="radio"><span>相符</span>
                                        <input name="jxs" class="radio" value="0" type="radio"><span>不相符</span>
                                    </p>
                                </td>
                                <td width="400">
                            ...
                            <tr>
                                ...
                                <td class="cell">
                                    <p class="tac fs14">
                                        <input name="address" checked="" class="radio" type="radio" value="1"><span>相符</span>
                                        <input name="address" class="radio" type="radio" value="0"><span>不相符</span>
                                    </p>
                                </td>
                                <td width="400">
                            ...
                            <tr>
                                ...
                                <td class="cell">
                                    <p class="tac fs14">
                                        <input name="jiaoche" checked="" class="radio" type="radio" value="1"><span>相符</span>
                                        <input name="jiaoche" class="radio" type="radio" value="0"><span>不相符</span>
                                    </p>
                                </td>
                                <td width="400">
                            ...
                            <tr>
                                ...
                                <td class="cell">
                                    <p class="tac fs14">
                                        <input name="price" checked="" class="radio" type="radio" value="1"><span>相符</span>
                                        <input name="price" class="radio" type="radio" value="0"><span>不相符</span>
                                    </p>
                                </td>
                                <td width="400">
                    ...
                    <table class="tbl">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="cell">
                                    <p class="tac fs14">
                                        <input name="biaozhun" checked="" class="radio" type="radio" value="1"><span>相符</span>
                                        <input name="biaozhun" class="radio" type="radio" value="0"><span>不相符</span>
                                    </p>
                                </td>
                                <td width="400">
                            ...
                            <tr>
                                ...
                                <td class="cell">
                                    <p class="tac fs14">
                                        <input name="csys" checked="" class="radio" type="radio" value="1"><span>相符</span>
                                        <input name="csys" class="radio" type="radio" value="0"><span>不相符</span>
                                    </p>
                                </td>
                                <td width="400">
                            ...
                            <tr>
                                ...
                                <td class="cell">
                                    <p class="tac fs14">
                                        <input name="nsys" checked="" class="radio" type="radio" value="1"><span>相符</span>
                                        <input name="nsys" class="radio" type="radio" value="0"><span>不相符</span>
                                    </p>
                                </td>
                                <td width="400">
                            ...
                            <tr>
                                ...
                                <td class="cell">
                                    <p class="tac fs14">
                                        <input name="licheng" checked="" class="radio" type="radio" value="1"><span>相符</span>
                                        <input name="licheng" class="radio" type="radio" value="0"><span>不相符</span>
                                    </p>
                                </td>
                                <td width="400">
                            ...
                            <tr>
                                ...
                                <td class="cell">
                                    <p class="tac fs14">
                                        <input name="chuchang" checked="" class="radio" type="radio" value="1"><span>相符</span>
                                        <input name="chuchang" class="radio" type="radio" value="0"><span>不相符</span>
                                    </p>
                                </td>
                                <td width="400">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="300" class="p10">
                                        <div class="btn-group m-r time-sl">
                                          <div class="form-group psr pdi-control">
                                            <input style="" name="shangpai_time" type="text" placeholder="{{date('Y-m-d')}}" class="form-control " onfocus="WdatePicker({minDate:'2015-12-2 00:00:00',startDate:'2015-12-19 00:00:00' });">
                                            <i class="rili"></i>
                                          </div>
                                        </div>
                                    </td>
