...
@section('content')
  <div style="overflow: visible;" class="container content m-t-86 pos-rlt " ms-controller="custom">
       ...
       <div class="step">
		...
		<form action="{{ url('dealer/pdisave') }}" method="post" name="item-form-notice" >
        <div class="wapper has-min-step">
            ...
            <div class="box">
                ...
                <div class="box-inner  box-inner-def">
                            ...
                            <tr>
                                <td width="660">
                                    <table class="tbl2" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>厂商指导价：</b>{{$carmodelInfo['zhidaojia']}}</p></td>
                                        </tr>
                                        <tr>
                                            <td><p><b>车辆类别：</b>
                                             <?php if ($buytype==0): ?>
                                        ...
                                        <tr>
                                            <td><p><b>经销商裸车开票价格：</b>{{$baojia['bj_lckp_price']}}</p></td>
                                            <td><p><b>付款方式：</b>
                                            ...
                                            <td colspan="2">
                                                <div class="psr">
                                                  ...
                                                  <p class="tm detail" style="width:470px">
                                                    ...
                                                    <label>歉意金3：499.00元（2015-10-25  10：57：57）</label>
                                ...
                                <td>
                                    <div class="times times2" style="height:450px">
                                        ...
                                        <p class="tac fs14">离交车通知发出时限还剩<span class="juhuang">{{$surplus_time_notice}}</span></p>
                                                ...
                                                <table class="tbl tbl3">
                                                   ...
                                                   <?php 
                                                      ...
                                                      foreach ($xzj as $key =>$value) {
                                                          if(!$value['xzj_yc'] || !$value['is_install'] || $value['num']<1) continue;
                                                   ?> 
                                                   <tr>
                    ...
                    <?php if ($shangpai_area==$dealer['d_shi']): ?>
                      <?php if ($baojia['bj_shangpai']): ?>
                        <p class="fs14"><b>是否由经销商代办上牌： </b>确定代办上牌</p>
                          ...
                          <p class="fs14"><b>客户自己上牌违约金赔偿：</b><?php echo $baojia['bj_license_plate_break_contract'] ?></p>
                      <?php else: ?>
                    ...
                    <p class="fs14"><b>交车当场移交客户的文件资料：</b><span>{{$wenjian}}（客户电话：134779921356）</span></p>
                               ...
                               <table class="tbl">
                                  <tbody>
                                      ...
                                      <tr>
                                          ...
                                          <td width="300">
                                              <span>testVIN123456</span>
                                              <textarea style="width:240px;" name="vin" id="" cols="30" rows="1">testVIN123456</textarea>
                                      ...
                                      <tr>
                                          ...
                                          <td width="300">
                                              <span>testFDJ123456</span>
                                              <textarea  style="width:240px;" name="engine_no" id="" cols="30" rows="1">testFDJ123456</textarea>
                                              <span class="edit show" ms-on-click="edit"></span>
                                          </td>
                                      </tr> 
                                      <tr>
                                          ...
                                          <td width="300">
                                              ...
                                              <input onfocus="WdatePicker({startDate:'2015-12-19 00:00:00',dateFmt:'yyyy-MM-dd' });" style="width:240px;display: none;text-align: left;" name="production_date" id=""  value="2015-10-21"/>
                                              <span class="edit show" ms-on-click="edit"></span>
                                          </td>
                                      </tr> 
                                      <tr>
                                          ...
                                          <td width="300">
                                              <span>80</span>
                                              <textarea style="width:240px;" name="mileage" id="" cols="30" rows="1">80</textarea>
                                              <span class="edit show" ms-on-click="edit"></span>
                                          </td>
                                      </tr> 
                                  </tbody>
                               ...
                               <?php foreach ($dates as $key => $value): ?>
                                 ...
                                 <dl class="sjd">
                                   <dd class="first" ms-on-click="hideSJD({{$key}},'{{$value}}')">
                                     <label>
                                        <input type="radio" ms-attr-name="pditime_jc[{{$key}}]" name="pditime_jc[{{$key}}][]" value="{{ddate($value,4)}} 上午">
                                   ...
                                   <dd ms-on-click="hideSJD({{$key}},'{{$value}}')">
                                     <label>
                                        <input type="radio" ms-attr-name="pditime_jc[{{$key}}]" name="pditime_jc[{{$key}}][]" value="{{ddate($value,4)}} 下午">
                                   ...
                                   <dd ms-on-click="hideSJD({{$key}},'{{$value}}')" class="last">
                                     <label>
                                        <input type="radio" ms-attr-name="pditime_jc[{{$key}}]" name="pditime_jc[{{$key}}][]" value="{{ddate($value,4)}} 上午/下午">
                     ...
                     <table class="tbl2" width="73%" style="margin:0 auto">
                       <tr>
                         <td width="50%" class="tac">
                         	<input value="提交修改" class="btn btn-s-md btn-danger fs16" type="button" ms-on-click="send_notice">
          ...
          <input type="hidden" name="currentstatus" value="{{$cart_sub_status}}">
			        ...
			        <p class="fs14 m-t-10"><b>请选择：</b></p>
                        ...
                        <table class="tbl bgtbl ml20">
                            ...
                            <?php if(count($xzj_yc_install_front)>0):?>
                            <?php foreach($xzj_yc_install_front as $kk=>$vv):?>
                            ...
                            <input type="hidden" name="xzjModelPrice[{{$vv['xzj_id']}}]" value="{{$vv['price']}}">
                            ...
                            <tr data-id="3">
                                ...
                                <td class="tac">{{$vv['num']*$vv['xzj_guide_price']}}</td>
                            </tr>
                            <?php endforeach;?>
                           <?php endif;?>
                        </table>
                        ...
                        <table class="tbl bgtbl ml20 bgtbl-mini">
                            ...
                            <tr data-id="3">
                                <td>{{ $value['title']}}</td>
                                <td align="center">
                                <input type="hidden"  value="<?=!empty($modifyLogZengpin[$value['id']]['num'])?$modifyLogZengpin[$value['id']]['num']:$value['num']?>"  name="origin_zengping[{{$value['id']}}]">
                                    <div class="xuan">
                                        <div class="x-w"> 
                                            <a ms-click="prev2" class="prev">-</a>
                                            <input type="text" readonly value="<?=!empty($modifyLogZengpin[$value['id']]['num'])?$modifyLogZengpin[$value['id']]['num']:$value['num']?>" class="input" name="zengping[{{$value['id']}}]">
                        ...
                        <p class="tac">
                        <input value="提交修改" class="btn btn-s-md btn-danger fs16" type="submit" >
                        </p>
                        <p class="tac">
