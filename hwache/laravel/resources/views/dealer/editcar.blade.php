        ...
        <div class="wapper has-min-step">
            ...
            <div class="box">
                ...
                <div class="box-inner  box-inner-def">
                    ...
                    <table class="tbl">
                        ...
                        <?php if ($baojia['bj_producetime']): ?>
                            <?php foreach ($xzj as $key => $value): 
                                  if($value['xzj_front'] || !$value['xzj_yc']) continue;
                            ?>
                              <tr>
                                   <td class="tac"><?php echo $value['xzj_title']; ?></td>
                                   <td class="tac"><?php echo $value['xzj_model']; ?> /<?php echo $value['xzj_notice']; ?></td>
                                   <td class="tac"><?php echo $value['xzj_guide_price']; ?></td>
                    ...
                    <h2 class="title">可为客户办理的其他上牌资料（等待客户选择）</h2>
                ...
                <?php endif ?>
                    ...
                    <p class="fs14 ">已装原厂选装精品：</p>
                        ...
                        <table class="tbl bgtbl " style="width: 100%">
                            ...
                            $editxzj_count=0.00;
							if(count($editxzj)>0){
                             foreach ($editxzj as $key => $value){
                              if ($value['num']<1) continue; 
                              ?>
                              <tr data-id="4">
                                  <td class="tac">{{$value['xzj_title']}}</td>
                                  <td class="tac">{{$value['xzj_model']}} /{{$value['xzj_notice']}}</td>
                                  <td class="tac">{{$value['xzj_guide_price']}}</td>
                                  <td class="tac">{{$value['num']}}</td>
                                  <td class="tac">{{$value['num']*$value['xzj_guide_price']}}</td>
                              </tr>
                            <?php 
								$editxzj_count+=$value['num']*$value['xzj_guide_price'];
                             }
							}
                            ?>
                        ...
                        <p class="fs14">
                            <small class="wp45 fr tar di mr150"><span>合计价值：<label>{{$editxzj_count}} 元</label></span></small>
                        ...
                        <table class="tbl bgtbl bgtbl-mini fl">
                            ...
                            <?php if(count($editzengpin)>0){?>
                            <?php foreach ($editzengpin as $key => $value): ?>
                              ...
                              <tr data-id="3">
                                ...
                                <td class="tac">
                                  <p class="fs14">{{getInstall($value['is_install'])}}</p>
                                </td>
                            </tr>
                            <?php endforeach ?>
                            <?php }?>
