       ...
       <div class="step">
        ...
        <div class="wapper has-min-step">
            ...
            <div class="box">
                ...
                @if(isset($mediate['itemid']) && $mediate['itemid']>0)
                <div class="step-n step-n-2-2"></div>
                @else
                <div class="step-n step-n-2-1"></div>
                @endif
                
                
                <div class="tbl m-t-10">
                    <p class="fs14 tdu "><b>1.主要问题</b></p>
                    ...
                    <div class="clear"></div>
                    <textarea class="txtarea-s " placeholder="" disabled>{{$dispute['content']}}</textarea>                   

                    <p class="fs14 tdu  m-t-10"><b>2.相关证据</b></p>
                    <div class="m-t-10">
                        <span class="blue fl ">
                ...
                @if(!empty($defend))
                <p class="fs14 bl5"><b class="ml10">客户申辩说明“<span class="juhuang">{{$dispute['content']}}</span>”</b></p>
                <div>
                	<textarea class="txtarea" placeholder="请输入申辩内容" disabled style="width: 80%;height:100px">{{$defend['content']}}</textarea>
                    <div class="clear"></div>
                    <br>
                    <span class="blue fl ">
                    ...
                    <div class="clear"></div>
                    <div class="fs14 time-wapper-p"><i class="icon-time fl"></i><span class="fl ml5">**小时**分**秒</span><div class="clear"></div></div>
                    
                    <div class="clear"></div>
                </div>
                <div class="clear"></div>
                @else
                <p class="fs14 bl5"><b class="ml10">客户正在申辩说明“<span class="juhuang">{{$dispute['content']}}</span>”,敬请等待......</b></p>
                @endif
                <div class="clear"></div>
                <hr class="dashed-2">                
	                @if(!empty($dispute['resupply']))
	                	<h2 class="title">平台核实   </h2>
	                	@if(empty($dispute['resupply_evidence']))
			                <form action="" method="post" enctype="multipart/form-data">
			                <p class="fs14 bl5"><b class="ml10">请补充材料清楚说明“<span class="juhuang">{{$dispute['resupply']}}</span>”</b></p>
						...
						@else
							<div class="fs14 bl5">
							<b class="ml10">请补充材料清楚说明“<span class="juhuang">{{$dispute['resupply']}}</span>”</b>
            				</div>
							<p class="fs14 tdu  m-t-10"><b>证据材料：</b></p>
			                <div class="m-t-10">
			                        <span class="blue fl ">
			                        <?php $dispute['resupply_evidence'] = unserialize($dispute['resupply_evidence']);?>
			                        @foreach($dispute['resupply_evidence'] as $k =>$v)
                ...
                @if(empty($dispute['dispute_hejie']))
	                <form action="{{url('dealer/dispute')}}/{{$order_num}}" method="post">
	                <div>
	            	...
	            	<input type="hidden" value="{{$dispute['id']}}" name="dispute_id" >
	            	<input type="hidden" name="_token" value="{{ csrf_token() }}">
				...
				@else
					<div>
					<textarea class="form-control pdi-control m-t-10 w70" cols="66" rows="3" disabled>{{$dispute['dispute_hejie']}}</textarea>
					 <p class="m-t-10">
	                       <a href="javascript:;" class="btn btn-s-md btn-danger fl  bt oksure ml20">已提交</a>
	                    </p>
	                    <div class="clear"></div>
             ...
             @if(!empty($mediate))
                <div class="fs14 bl5" style="height: 19px;">
                    ...
                    <input value="{{$mediate['content']}}" style="width: 600px;margin-top: -3px;" type="text"  class="form-control pdi-control fl" disabled>
                    <div class="clear"></div>
                </div>
	            <div class="clear"></div>
	            <p class="m-t-10">
