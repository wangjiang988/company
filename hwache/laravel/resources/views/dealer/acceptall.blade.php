        ...
        <div class="wapper has-min-step">
            ...
            <div class="box">
                ...
                <div class="box-inner  box-inner-def">
                                            ...
                                            <td colspan="2">
                                                <div class="psr">
                                                  ...
                                                  <p class="tm detail">
                                                    ...
                                                    <label>歉意金2：499,00元（2015-10-26   10：57 ：57）</label>
                                                  </p>
                                                </div>
                                            </td>
                                        </tr>
                                    ...
                                    <div class="times times2">
                                        ...
                                        <div class="jd">
                                            ...
                                            <div class="jd-wapper">
                                                ...
                                                <p class="pl20 lh25  m-t-10"><b>客户会员号： </b>{{formatNum($buy_id,1)}} </p>
                                             
                                                <p class="pl20 lh25"><b>客户承诺上牌地区：   </b>{{$shangpai_area}}</p>
                                                <p class="pl20 lh25"><b>客户车辆用途：   </b>{{carUse($buytype)}}</p>
                                                <p class="pl20 pt">
                                                  <b>上牌车主身份类别： </b>
                                                  <span class="fr" style="width: 125px;color:#8e8d8d;text-align: left;margin-top: -5px;">{{$shenfen}}</span> 
                                                  <span class="clear"></span>
                                                </p>
                                                <p class="pl20 lh25"><b>客户买车担保金：  {{$guarantee}} 元</b> </p>
                                                <style>
                                                    @-moz-keyframes pulse {
                                                      0% {
                                                        width:0;
                    ...
                    <h2 class="title">需要经销商为客户办理的其他上牌资料</h2>
                    <table class="tbl2">
                    @if(!empty($ziliao) && count($ziliao)>0 )
                    <?php foreach ($ziliao as $key => $value): ?>
                      <tr>
                            <td valign="top"><span class="tal fs14 nopadding"  >{{$value['title']}}：</span></td>
                            <td class="cell"> 
                                <div>
                                    <span>费用 {{$value['fee']}} 元，办理时间 {{$value['days']}} 个自然日 </span>
                                </div>
                    ...
                    <p class="fs14">行驶里程：{{$editcarinfo['licheng']}} 公里</p>
                      <?php if ($baojia['bj_jc_period']): ?>
                    <p class="fs14">交车周期：{{$editcarinfo['zhouqi']}} 个月</p>
                    <?php endif ?>
                    ...
                    <p class="fs14 ">已装原厂选装精品：</p>
                        <table class="tbl bgtbl " style="width: 100%">
                            ...
                            <?php 
                            $count=0.00;
                            foreach ($xzj_edit as $key => $value){ 
                            if ($value['num']==0) continue;
                              ?>
                             
                              <tr data-id="3">
                                <td class="tac">{{$value['xzj_title']}}</td>
                                <td  class="tac">{{$value['xzj_model']}}</td>
                                <td class="tac">{{$value['xzj_guide_price']}}</td>
                                <td class="tac">{{$value['num']}}</td>
                                <td class="tac">{{$value['xzj_guide_price']*$value['num']}}</td>
                            </tr>
                            <?php 
                                $count+=$value['xzj_guide_price']*$value['num'];
                            } ?>    
                        ...
                        <p class="fs14">
                            <small class="wp45 fr tar di mr150"><span>合计价值：{{$count}} 元<label></label></span></small>
                        ...
                        <table class="tbl bgtbl bgtbl-mini fl">
                            <tr>
                             ...
                             @foreach($zengpin_edit as $key =>$value)
                             <?php if ($value['num']==0) continue; ?>
                        <tr>
                            <td><p class="fs14 tac">{{ $value['title']}}</p></td>
                            <td><p class="fs14 tac">{{ $value['num']}}</p></td>
                            <td><p class="fs14 tac">
