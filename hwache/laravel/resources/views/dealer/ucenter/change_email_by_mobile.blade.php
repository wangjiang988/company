...
@section('content')
                    ...
                    <div class="content-wapper ">
                        ...
                        <div class="ml160 mt60">
                            <form action="" method="post" name="emailform">
                                ...
                                <p class="fs14 m-t-10">
                                   ...
                                   <a href="javascript:;" ms-on-click="SendCode('{{$member['member_mobile']}}',5)" data-s="重新获取" data-send="重新获取($1)" class="ml20 pull-left btn btn-s-md btn-danger fs14 btn-s bt sure btn-code" style="margin-top: -4px;">获取验证码</a>
                                   <div class="clear"></div>
                                </p>
                        ...
                        <br /><br />
                        <p class="tac"><a href="javascript:;" ms-on-click="CheckMobileCode('email')" data-s="重新获取" data-send="重新获取($1)"  class="btn btn-s-md btn-danger fs16 btn-s w150">下一步</a></p>
                        <p class="tac"><a href="/dealer/changeemail/byemail" class="juhuang">使用已验证邮箱修改邮箱>></a></p>
