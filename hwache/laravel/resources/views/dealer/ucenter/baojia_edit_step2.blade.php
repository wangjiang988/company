...
@section('content')
                    ...
                    <input type='hidden' name='_token' value="{{csrf_token()}}">
                        <div class="content-wapper ">
                           @if($baojia['bj_is_xianche']==1)
                            <table class=" custom-info-tbl noborder">
                             <tbody>
                                   ...
                                   <td class="tal">
                                      <div class="btn-group btn-jquery-event-use-id btn-auto">
                                          <button data-toggle="dropdown" class="btn btn-select btn-select-normal btn-default dropdown-toggle dropdown-company">
                                              <span class="dropdown-label"><span>{{$carinfoArray['body_color'][$carAttr['body_color']]}}</span></span>
                                              <span class="caret"></span>
                                          </button>
                                          <ul class="dropdown-menu dropdown-company">
                                              <input type="hidden" name="body_color" value="{{$carAttr['body_color']}}">
                                   ...
                                   <td class="tal">
                                      <div class="btn-group btn-jquery-event-use-id btn-auto">
                                          <button data-toggle="dropdown" class="btn btn-select btn-select-long btn-default dropdown-toggle">
                                              <span class="dropdown-label"><span>{{@$carinfoArray['interior_color'][$carAttr['interior_color']]}}</span></span>
                                              <span class="caret"></span>
                                          </button>
                                          <ul class="dropdown-menu dropdown-select dropdown-long">
                                              <input type="hidden" name="interior_color" value="{{@$carAttr['interior_color']}}">
                               ...
                               <tr>
                                   ...
                                   <td class="tal">
                                      <input id="mileage" placeholder="" type="text" name="bj_licheng" class="form-control custom-control custom-control-min abs" value="{{$baojia['bj_licheng']}}">
                            ...
                            <table class="tbl tbl-blue wp100">
                              <tbody>
                                <tr class="title-tag">
                                  <th class="tac  select"><span>选择</span></th>
                                ...
                                <tr class="loading none">
                                  <td colspan="6">
                                     ...
                                     <p class="tac"><a href="javascript:;" class="juhuang tdu goods-add-link">添加</a></p>
                                     <div class="m-t-10"></div>
                                  </td>
                                </tr>
                                ...
                                <tr  data-id="{{$k}}">
                                  ...
                                  <td class="tac count">
                                    <div class="checkbox-wrapper inline counter-wrapper">
                                        ...
                                        <input class="" type="text" name="xzj_num[{{$v['xzj_id']}}]" id="" value="{{isset($bj_xzj[$v['xzj_id']]['num'])?$bj_xzj[$v['xzj_id']]['num']:1}}" max="{{$v['xzj_max_num']}}" <?php if(!isset($bj_xzj[$v['xzj_id']])){echo 'disabled';}?>>
                                ...
                                @endforeach
                                @else
                                <tr><td colspan="7"><p class="tac mt10">暂无</p></td></tr>
                                @endif
                                
                              </tbody>
                            </table>
                            <p class="tar"><a href="javascript:;" class="juhuang tdu goods-modify-link none">修改</a></p>
                       ...
                       @else        
                             ...
                             <tbody>
                               <tr>
                                   ...
                                   <td class="tal" width="425">
                                      <div class="btn-group btn-jquery-event-use-id btn-group-auto">
                                          <button data-toggle="dropdown" class="btn btn-select btn-select-normal btn-default dropdown-toggle dropdown-company">
                                              <span class="dropdown-label"><span>{{$carinfoArray['body_color'][$carAttr['body_color']]}}</span></span>
                                              <span class="caret"></span>
                                          </button>
                               ...
                               <tr>
                                   ...
                                   <?php 
                                   $bj_interior_color = @unserialize($baojia['bj_temp_internal_color']);
                                   $bj_interior_color = is_array($bj_interior_color)?$bj_interior_color:array();
                                   
                                   ?>
                                   @if(isset($carinfoArray['interior_color']) && count($carinfoArray['interior_color'])>0)
	                                    @foreach($carinfoArray['interior_color'] as $k=>$v)
	                                    	<label class="ml10"><input type="checkbox" class="fl" name="interior_color[]" id="" value="{{$k}}" <?php if(array_search($k,$bj_interior_color)!==false){echo 'checked';}?>><span class="fl ml5 noweight">{{$v}}</span></label>
	                                    @endforeach
                                   @endif
                                   ...
                                   <td class="tal">
                                      <div class="btn-group btn-jquery-event-use-id">
                                          <button data-toggle="dropdown" class="btn  btn-default dropdown-toggle">
                                              ...
                                              <span>
                                              <?php 
                                              if($baojia['bj_jc_period']==1){
                                              	echo "一";
                                              }elseif($baojia['bj_jc_period']==3){
                                              	echo "三";
                                              }else{
                                              	echo "六";
                                              }
                                          ...
                                          <ul class="dropdown-menu">
                                              <input type="hidden" name="bj_jc_period" value="{{$baojia['bj_jc_period']>0?$baojia['bj_jc_period']:'6'}}">
						...
						@endif
                            <div class="m-t-10"></div>
                            <p><b>免费礼品和服务：</b><a href="javascript:;" class="juhuang tdu add-solution"><b>新增项目</b></a></p>
                  ...
                  <div id="SolutionAddWin" class="popupbox" >
                      ...
                      <div class="popup-wrapper ">
                          <form action="/dealer/baojia/ajaxsubmit/edit-zengpin" name="baojia-submit-form" method="post">
                    		  <input type='hidden' name='_token' value="{{csrf_token()}}">
