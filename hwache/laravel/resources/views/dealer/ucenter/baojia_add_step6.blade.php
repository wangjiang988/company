                        ...
                        <div class="content-wapper ">
                           <div class="box">
                               ...
                               @if($jnbt==1)
                                  ...
                                  <label class="radio-label ml50"><input type="radio" name="bt_status" id="" value='0' {{$dealerInfo['bt_status']==0?"checked":""}}><span>不提供</span></label>
                                  <label class="radio-label ml50"> 
                                        <table cellpadding="0" cellspacing="0">
                                          <tbody><tr>
                                            <td valign="top">
                                                  <input type="radio" name="bt_status" id="" value='1' {{$dealerInfo['bt_status']==1?"checked":""}}> 
                                                  <span>提供</span>
                                                  <p class="ml20">
                                                     <input type="radio" name="jnbt" id="" {{$dealerInfo['bt_status']==1?"checked":""}}>
                                                     <span>经销商代办上牌的，交车上牌时当场兑现；由客户本人上牌的，上牌资料齐全后，经销商垫付给客户，</span>
                                                     <br><span>时限</span>
                                                     <input class="card-input card-txt-price" type="text" name="bt_work_day" id="" value="{{$dealerInfo['bt_status']==1?$dealerInfo['bt_work_day']:""}}">
                                                     <span>个工作日。</span>
                                                   ...
                                                   <p class="ml20">
                                                     ...
                                                     <input class="card-input card-txt-price" type="text" name="bt_work_month" id="" value="{{$dealerInfo['bt_status']==1?$dealerInfo['bt_work_month']:""}}">
                                                     <span>个月。</span>
                                                     <span class="error-div red">*输入有误，请输入正确的整数格式，例如：2</span>
                                                   </p>
                                  ...
                                  <p class="ml20"><b>地方政府置换补贴：</b><input type="checkbox" name="bj_zf_butie" id="" value='1' {{$dealerInfo['bt_gov']==1?"checked":""}}>可为客户提供协助</p>
                                  <p class="ml20"><b>厂家或经销商置换补贴：</b><input type="checkbox" name="bj_cj_butie" id="" value='1' {{$dealerInfo['bt_factory']==1?"checked":""}}>有</p>
                               	  </div>
                               </div>
                           </div>
                           <div class="box">
                           ...
                           <div class="box">
                               ...
                               <label class="radio-label ml50 noweight">
                                 <input type="radio" class="time-set" name="fulltime" id="" value='0'>
                                 <span>按设置生效及有效时间
                                   <span class="smip-gray">（设置工作时间之外、资金池可提现余额不足、主动下架操作、被客户购买后库存为
                               ...
                               <div class="no-offer ml50">
                                   ...
                                   <div class="btn-group m-r time-sl fl ml10">
                                      <div class="form-group psr pdi-control">
                                        <input readonly="" type="text" value="{{time()>strtotime(date('Y-m-d').' 17:00:00')?date('Y-m-d',strtotime('+1 day')):date('Y-m-d')}}" class="form-control select-time-control start" onfocus="WdatePicker({startDate:'1900-01-01',dateFmt:'yyyy-MM-dd' });" name='start_time_1'>
                                        <i class="rili"></i>
                                      </div>
                                   </div>
                                   <div class="btn-group m-r time-sl fl ml20">
                                      <div class="form-group psr pdi-control">
                                        <input value="{{time()>strtotime(date('Y-m-d').' 17:00:00')?'09:00':date('H:i')}}" type="text" class="form-control work-control am" name='start_time_2'>
                               ...
                               <div class="no-offer ml50">
                                   ...
                                   <div class="btn-group m-r time-sl fl ml10">
                                      <div class="form-group psr pdi-control">
                                        <input readonly="" type="text" value="{{time()>strtotime(date('Y-m-d').' 17:00:00')?date('Y-m-d',strtotime('+1 day')):date('Y-m-d')}}" class="form-control select-time-control start" onfocus="WdatePicker({startDate:'1900-01-01',dateFmt:'yyyy-MM-dd' });" name='end_time_1'>
                                        <i class="rili"></i>
                                      </div>
                                   </div>
                                   <div class="btn-group m-r time-sl fl ml20">
                                      <div class="form-group psr pdi-control">
                                        <input value="17:00" type="text"  class="form-control work-control am" name='end_time_2'>
                                        <i class="icon-times"></i>
                                      </div>
                                   </div>
                                   <div class="clear"></div>
                               ...
                               <div class="mt20">
								...
								@if(empty($baojia['bj_dealer_internal_id']))
                                  <div class="ml20 checkbox-wrapper inline counter-wrapper">
                                      ...
                                      <input class="" type="text" name="bj_num" id="" value="1" max="9999">
