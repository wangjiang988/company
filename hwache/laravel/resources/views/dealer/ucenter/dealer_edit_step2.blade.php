...
@section('content')
                    ...
                    <div class="custom-set-flow-step-wrapper">
                           <ul class="custom-set-flow-step custom-normal-flow-step">
                             ...
                             <li class="last"><a href="/dealer/editdealer/edit/{{$id}}/step3"><span><span>竞争分析</span></a></li>
                             <div class="clear"></div>
                         </ul>
                     </div>
                    <div id="vue">
                        <div class="content-wapper ">
                           ...
                           <div class="tbl-list-tool-panle">
                                <p><b>车辆首年商业保险</b></p>
                                <form name="save-form" method="post" action="/dealer/editdealer/edit/{{$daili['id']}}/step2">
                                  ...
                                  <a href="javascript:;" @click="save_action(2)" class="btn btn-danger fs18 tac">保存修改</a>
                                  <p class="mt10 red"><span>温馨提示：</span>保存各项修改内容后，请到“竞争分析”页面一并提交重审！</p>
                                  @else
                                  <a href="javascript:;" @click="save_action(2)" class="btn btn-danger fs18">修改</a>
                                  @endif
