                    ...
                    <form action="/dealer/baojia/edit/{{$baojia['bj_id']}}/5" name="baojia-submit-form" method="post">
                        ...
                        <div class="content-wapper   ml-10">
                           ...
                           <div class="tbl-list-tool-panle valite-txt">
                              ...
                              <label class="radio-label"><input type="radio" name="bj_shangpai" id="" value='1' {{$dealerInfo['dl_shangpai']==1?"checked":""}}><span>本地客户上牌手续必须由经销商代办</span>

                              </label>
                              <label class="radio-label"><input type="radio" name="bj_shangpai" id="" value='0' {{$dealerInfo['dl_shangpai']==0?"checked":""}}><span>本地客户自由办理</span></label>
                              <div class="clear"></div>
                           ...
                           <div class="tbl-list-tool-panle  valite-1">
                              ...
                              <label class="radio-label ml50"><input type="radio" name="benrenshangpai" id="" value='1' {{$dealerInfo['dl_shangpai_object']==1?"checked":""}}><span>有此要求</span><span class="ml10"><b>客户本人上牌违约赔偿金额：</b>￥</span>
                                  <div class="edit-wp psr ml5" >
                                      <input maxlength="8" class="abs noweight" type="text" name="bj_license_plate_break_contract" value="{{$dealerInfo['dl_shangpai_object']==1?$dealerInfo['dl_shangpai_object_fee']:''}}">
                                      <span class="edit"></span>
                              ...
                              <label class="radio-label ml50"><input maxlength="8" type="radio" name="benrenshangpai" id="" value='0' {{$dealerInfo['dl_shangpai_object']==0?"checked":""}}><span>无此要求</span></label>
                           </div>

                          <div class="tbl-list-tool-panle  valite-txt" >
                              <p class="blue"><b>二、上临时牌照（临时移动牌照）</b></p>
                              <label class="radio-label"><input type="radio" name="bj_linpai" id="" value='1' {{$dealerInfo['dl_linpai']==1?"checked":""}}><span>车辆临时移动牌照手续必须由经销商代办</span> 
                                    
                              </label>
                              <label class="radio-label"><input type="radio" name="bj_linpai" id="" value='0' {{$dealerInfo['dl_linpai']==0?"checked":""}}><span>本地客户自由办理</span></label>
                              ...
                              <span class="error-info error-div juhuang">*请输入数字格式，且须为100的整数倍，例如100</span>
                          ...
                          <div class="tbl-list-tool-panle valite-3">
                              ...
                              <div class="radio-label"><input type="radio" name="xyk_status" id="" value='0' {{$dealerInfo['xyk_status']==0?"checked":""}}><span>不限</span></div>
                              <div class="radio-label mt10">
                                
                                    <table cellpadding="0" cellspacing="0">
                                      <tbody><tr>
                                        <td valign="top">
                                          <input type="radio" name="xyk_status" id="" value='1' {{$dealerInfo['xyk_status']==1?"checked":""}}> 
                                        ...
                                        <td valign="top">
                                          <span>次；超出次数收费：</span>
                                            ...
                                            <div class="ml50">
                                           <p>
                                             <input type="checkbox" name="" id=""  {{$dealerInfo['xyk_status']==1?"checked":""}}  class='clear-value'>
                                             <span>刷卡金额的</span>
                                             <input maxlength="8" class="card-input card-txt-price abs max-valite" type="text" name="xyk_per_num" id="" value="{{$dealerInfo['xyk_status']==1?$dealerInfo['xyk_per_num']:""}}">
                                             <span>%（百分之）</span>
                                           ...
                                           <p>
                                             <input type="checkbox" name="" id="" {{$dealerInfo['xyk_status']==1?"checked":""}}  class='clear-value'>
                                             <span>每次</span>
                                             <input maxlength="8" class="card-input card-txt-price abs" type="text" name="xyk_yuan_num" id=""  value="{{$dealerInfo['xyk_status']==1?$dealerInfo['xyk_yuan_num']:""}}">
                                             <span>元（封顶）</span>
