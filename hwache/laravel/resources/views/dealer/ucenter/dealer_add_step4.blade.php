                    ...
                    <div class="content-wapper ">
                       ...
                       <div class="m-t-10"></div>
                        @if($daili['dl_step'] == 4)
                         ...
                         <div class="m-t-10"></div>
                         <p class="tac">
                            <a href="javascript:;" class="btn btn-danger fs18 registrationCondition-adv isnext">下一步</a>
                       ...
                       <form action="/dealer/ajaxsubmitdealer/save-step/{{$dealer_id}}" name="next-form" method="post">
                         ...
                         <div class="m-t-10"></div>
                         <p class="tac">
                            <a href="javascript:;" class="btn btn-danger fs18 btn btn-danger fs18 registrationCondition-adv isnext">下一步</a>
                            <a href="/dealer/editdealer/check/{{$id}}/step3"  class="juhuang tdu ml5"><span>返回上一步</span></a>
