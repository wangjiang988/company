                    ...
                    <div class="content-wapper ">
                       ...
                       <div class="m-t-10"></div>
                        <form action="/dealer/ajaxsubmitdealer/save-step/{{$dealer_id}}" name="next-form" method="post">
                         ...
                         <a href="javascript:;" class="btn btn-danger fs18 btn btn-danger fs18 registrationCondition-adv">保存修改</a>
                         <p class="mt10 red tac"><span>温馨提示：</span>保存各项修改内容后，请到“竞争分析”页面一并提交重审！</p>
                         @else
                            <a href="javascript:;" class="btn btn-danger fs18 btn btn-danger fs18 registrationCondition-adv">修改</a>
                         @endif
