...
@section('content')
                    ...
                    <table class="tbl custom-info-tbl">
                         <tr>
                             ...
                             <td width="85" class="nobottomborder">
                                 <div class="pic-wrapper">
                                     ...
                                     <div class="pic">
                                         <img width="84" class="block" src="/upload/{{$member['seller_photo']}}" alt="" onerror="this.src='/themes/images/custom/custom-info-head.gif'">
                         ...
                         <tr>
                             ...
                             <td width="292">性别：男</td>
                             <td width="85" class="notopborder "></td>
                         </tr>
                         <tr>
                             <td width="380">身份证明文件类型：身份证</td>
                             <td colspan="2">证件号码：{{substr_replace($member['seller_card_num'],"********",6,6)}}</td> 
                         </tr>
                    </table>
                    <!--//联络方式-->
                    ...
                    <table class="tbl custom-info-tbl">
                         <tr>
                             <td width="380" class="nobottomborder">
                                ...
                                <div class="pic-wrapper">
                                    <a href="/dealer/member_info/modify_bank" class="modify modify-bank">修改</a>
                                </div>
