...
@section('content')
  <div class="container content m-t-86 pos-rlt " ms-controller="custom">
       ...
       <div class="step">
        ...
        <form action="{{ url('dealer/pdiconfirm') }}" method="post" name="item-form">
                      ...
                      <tr>
                        <td>
                            ...
                            <div class="ifl">
                                ...
                                <p class="fs14"><input class="radios" type="radio" name="act_date" value="Y" checked><span class="fn">接受客户希望日期（<?php foreach ($pdi_date_client as $key => $value): ?>
                                <?php if(empty($value)) continue;?>
                                {{$value}} 
                              <?php endforeach ?>），免收超期费</span></p>
                                <p class="fs14 m-t-10" style="width: 800px;">
                                  <input class="radios fl" type="radio" name="act_date" value="N">
                                  <span class="fn fl">与客户协商后定为</span>

                                  <div class="btn-group m-r fl"  style="width:160px;margin-top: -4px;">
                                      <div class="form-group psr">
                                        <input style="" type="text" name='jc_date' placeholder="" 
                                        class="form-control "  
                                  ...
                                  <input class="cqprice fl" type="text" name="over_fee">
                            ...
                            <div class="ifl">
                                ...
                                <p class="m-t-10">
                                    <input type="checkbox" class="fl radios" name="daijia[choose]" value='Y'>
                                    <b class="fl fn">代驾送车</b>
                                    <span class="fl">服务费：</span>
                                    <input class="cqprice fl" type="text" name="daijia[fee]"  value="">
                                    <span class="fl fn">元</span>
                                    <div class="clear"></div>
                                </p>
                                <p class="m-t-10">
                                    <b class="fl fn pl20">支付方式：</b>
                                    <input class="radios fl" type="radio" name="daijia[pay_type]" value='pay_first'>
                                    <span class="fn fl">提车时先支付后送车</span>
                                    <input class="radios fl" style="margin-left: 10px;" type="radio" name="daijia[pay_type]"  value='pay_wait_ok'>
                                ...
                                <p class="m-t-10">
                                    <input type="checkbox" class="fl radios" name="transport[choose]" value="Y">
                                    <b class="fl fn">板车运输送车</b>
                                    <span class="fl">服务费：</span>
                                    <input class="cqprice fl" type="text" name="transport[fee]"  value="">
                                    <span class="fl fn">元</span>
                                    <span class="fl">运输险保费：</span>
                                    <input class="cqprice fl" type="text" name="transport[bx_fee]"  value="">
                                    <span class="fl fn">元</span>
                                    <div class="clear"></div>
                                </p>
                                <p class="m-t-10">
                                    <b class="fl fn pl20">支付方式：</b>
                                    <input class="radios fl" type="radio" name="transport[pay_type]" value="pay_first">
                                    <span class="fn fl">提车时先支付后送车</span>
                                    <input class="radios fl" style="margin-left: 10px;" type="radio" name="transport[pay_type]" value="pay_wait_ok">
                                    <span class="fn fl">车送到目的地后当场支付</span>
                                    <div class="clear"></div>
                                </p>
                            </div>
                            ...
                            <div style="width: 96%;margin:0 auto;">
                                ...
                                <p class="m-t-10">
                                    <input type="radio" class="fl radios" name="bx[{{$k}}][choose]" value='Y'>
                                    <b class="fl fn">首年保费
                                    <?php
                                     ...
                                     ?>
                                    	：</b>
                                    <input class="cqprice fl" type="text" name="bx[{{$k}}][bf]"  value="">
                                    <span class="fl fn">元</span>
                                    <span class="fl ml20">说明：</span>
                                    <input class="cqprice sm fl" type="text" name="bx[{{$k}}][bfsm]"  value="">
                                    <div class="clear"></div>
                                </p>
                                <p class="m-t-10">
                                    <input type="radio" class="fl radios" name="bx[{{$k}}][choose]" value='N'>
                                ...
                                <p class="m-t-10">
                                    ...
                                    <span class="fl fn">元</span>
                                    <span class="fl ml20">说明：</span>
                                    <input class="cqprice sm fl" type="text" name="bx[{{$k}}][bfsm]" id="" value="">
                                    <div class="clear"></div>
                                </p>
                                <p class="m-t-10">
                                    <input type="radio" class="fl radios" name="bx[{{$k}}][choose]" value='N'>
                                                    ...
                                                    <?php foreach ($toubaofile_self as $key => $value): ?>
                                                      <tr>
                                                        ...
                                                        <td class="cell tac norightborder ">
                                                           <label><input type="radio" checked="checked"  style="width: auto" name="needfile[toubao][{{$value['id']}}]" value="{{$value['title'].','.$value['num']}}"><span class="fn">需要</span></label>
                                                           <label><input type="radio" style="width: auto" name="needfile[toubao][{{$value['id']}}]" value=""><span class="fn">不需要</span></label>
                                                        </td>
                                               ...
                                               <table class="tbl2" width="100%">
                                                    ...
                                                    <?php foreach ($shangpaifile_self as $key => $value): ?>
                                                      <tr>
                                                        ...
                                                        <td class="cell tac norightborder  ">
                                                           <label><input type="radio" checked="checked"  style="width: auto" name="needfile[shangpai][{{$value['id']}}]" value="{{$value['title'].','.$value['num']}}"><span class="fn">需要</span></label>
                                                           <label><input type="radio" style="width: auto" name="needfile[shangpai][{{$value['id']}}]" value=""><span class="fn">不需要</span></label>
                                                        </td>
                                               ...
                                               <table class="tbl2" width="100%">
                                                    ...
                                                    <?php foreach ($linpaifile_self as $key => $value): ?>
                                                      <tr>
                                                        ...
                                                        <td class="cell tac norightborder  ">
                                                           <label><input type="radio" checked="checked"  style="width: auto" name="needfile[linpai][{{$value['id']}}]" value="{{$value['title'].','.$value['num']}}"><span class="fn">需要</span></label>
                                                           <label><input type="radio" style="width: auto" name="needfile[linpai][{{$value['id']}}]" value=""><span class="fn">不需要</span></label>
                                                        </td>
                                               ...
                                               <table class="tbl2" width="100%">
                                                    ...
                                                    <?php foreach ($butiefile_self as $key => $value): ?>
                                                      <tr>
                                                        ...
                                                        <td class="cell tac norightborder  ">
                                                           <label><input type="radio" checked="checked"  style="width: auto" name="needfile[butie][{{$value['id']}}]" value="{{$value['title'].','.$value['num']}}"><span class="fn">需要</span></label>
                                                           <label><input type="radio" name="needfile[butie][{{$value['id']}}]" style="width: auto" value=""><span class="fn">不需要</span></label>
                                                        </td>
                                   ...
                                   <table class="tbl">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" class="nopadding ">
                                               <table class="tbl2" width="100%">
                                                    <tbody>
                                                    <?php foreach ($toubaofile as $key => $value): ?>
                                                      <tr>
                                                        <td width="189" class="bottomtborder ">
                                                            <p class="tac fs14">{{$value['title']}}</p>
                                                        </td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" class="nopadding">
                                               <table class="tbl2" width="100%">
                                                    <tbody>
                                                    <?php foreach ($shangpaifile as $key => $value): ?>
                                                      <tr>
                                                        <td width="189" class="bottomtborder ">
                                                            <p class="tac fs14">{{$value['title']}}</p>
                                                        </td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" class="nopadding">
                                               <table class="tbl2" width="100%">
                                                    <tbody>
                                                    <?php foreach ($linpaifile as $key => $value): ?>
                                                      <tr>
                                                        <td width="189" class="bottomtborder ">
                                                            <p class="tac fs14">{{$value['title']}}</p>
                                                        </td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" class="nopadding">
                                               <table class="tbl2" width="100%">
                                                    <tbody>
                                                    <?php foreach ($butiefile as $key => $value): ?>
                                                      <tr>
                                                        <td width="189" class="bottomtborder ">
                                                            <p class="tac fs14">{{$value['title']}}</p>
                                                        </td>
                            ...
                            <div style="width: 96%;margin:0 auto;">
                                ...
                                <div class="ifl" id="file" style="width:95%">
                                   ...
                                   <div class="fl wap">
                                     <p class="m-t-10">
                                        ...
                                        <input class="cqprice sm fl" type="text" name="project[0][name]"  value="">
                                        <b class="fl fn ml20">办理费用： </b>
                                        <input class="cqprice fl" type="text" name="project[0][money]"  value="">
                                        <span class="fl fn">元</span>
                                        <span class="fl fn ml20">需要时间：</span>
                                        <input class="cqprice fl day" type="text" name="project[0][day]"  value="">
                                        <span class="fl fn">天</span>
                                        <div class="clear"></div>
                                    </p>
                                    <p class="m-t-10">
                                        <span class="fl">交车时间：</span>
                                        <input class="fl radios" type="radio" name="project[0][effect]"  value="N">
                                        <b class="fl fn">无影响 </b>
                                        <input class="radios fl ml20" type="radio" checked="" name="project[0][effect]"  value="Y">
                                        <span class="fl fn">延后到：</span>
                                        <div class="btn-group m-r fl" style="width:160px;margin-top: -4px;">
                                            <div class="form-group psr">
                                              <input style="" type="text" name="project[0][jc_date]" placeholder="" class="form-control " onfocus="WdatePicker({minDate:'2015-12-2 00:00:00',startDate:'2015-12-19 00:00:00' });">
                                              <i class="rili"></i>
                                            </div>
                                        </div>

                                        <a class="juhuang fl del ml20">删除</a>
                                        <a class="juhuang fl goon ml20">继续添加</a>
                                        <div class="clear"></div>
                                    </p>
                                  </div>
                                </div>
                                ...
                                <div class="ifl" id="banli" style="width:95%">
                                   ...
                                   <div class="wap">
                                     <p class="m-t-10">
                                        <span class="fl">项目<span class="num">1</span>：</span>
                                        <input class="cqprice sm fl" type="text" name="project_not[0]"  value="">
                                        <a class="juhuang fl del ml20">删除</a>
                                        <a class="juhuang fl goon ml20">继续添加</a>
                                        <div class="clear"></div>
                                    </p>
                                ...
                                <div class="ifl" id="manzu" style="width:95%">
                                   ...
                                   <div class="wap">
                                     <p class="m-t-10">
                                        <span class="fl">项目<span class="num">1</span>：</span>
                                        <input class="cqprice sm fl" type="text" name="service_ok[0]"  value="">
                                        <a class="juhuang fl del ml20">删除</a>
                                        <a class="juhuang fl goon ml20">继续添加</a>
                                        <div class="clear"></div>
                                    </p>
                                ...
                                <div class="ifl" id="bumanzu" style="width:95%">
                                   ...
                                   <div class="wap">
                                     <p class="m-t-10">
                                        <span class="fl">项目<span class="num">1</span>：</span>
                                        <input class="cqprice sm fl" type="text" name="service_not[0]"  value="">
                                        <a class="juhuang fl del ml20">删除</a>
                                        <a class="juhuang fl goon ml20">继续添加</a>
                                        <div class="clear"></div>
                                    </p>
