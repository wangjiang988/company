                ...
                <div class="box-inner  box-inner-def">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="times times-error">
                                        ...
                                        <p class="pl20 pt"><b>客户会员号： </b>{{formatNum($buy_id)}} </p>
                                        <p class="pl20 pt"><b>客户车辆用途： </b><?php if ($buytype==0): ?>
                                              非营运个人用车
                                            <?php else: ?>
                                              非营运公司用车
                                            <?php endif ?> </p>
                                        <p class="pl20 pt"><b>客户承诺上牌地区： </b>{{$shangpaiarea}} </p>
                                        <p class="pl20 pt">
                                          <b>上牌车主身份类别： </b>
                  ...
                  <?php endif ?>
                    ...
                    <table class="tbl">
                       ...
                       <?php foreach ($xzjs as $key => $value): ?>
                        <?php if(!$value['xzj_yc'] || $value['xzj_front']) continue; ?>
                         <tr>
                    ...
                    <?php foreach ($ziliao as $key => $value): ?>
                      <p class="fs14">{{$value['title']}}：
                      <?php if ($value['ok']==1): ?>
                        费用人民币{{$value['fee']}}元，办理时间{{$value['days']}}个自然日
                        <?php else: ?>
                          请恕无法办理
                      <?php endif ?>
                       </p>
