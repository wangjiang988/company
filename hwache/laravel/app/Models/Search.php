...
class Search extends Model
{
    ...
    public function pageList($wheres , $areas,  $pageSize=10, $page=1, $cacheTime=2000,$order='region',$sort='asc'){
        ...
        $orderStr = ($order == 'price') ? 'hwache_price' : 'scopeOrder desc ,hwache_price';
    ...
    public function getBrandList($id){
        ...
        $col = "car_brand.gc_id,car_brand.gc_name,car_xi.detail_img,car_xin.gc_id AS xin_id,car_xin.gc_name AS xin_name,car_xi.gc_id AS xi_id,car_xi.gc_name AS xi_name";
        return self::select(DB::raw($col))
