  ...
  <tbody>
    ...
    <tr class="bd-line" >
      ...
      <td class="nscs-table-handle">
        ...
        <span><a href="javascript:void(0)" class="btn-blue" nc_type="dialog" dialog_title="处理" dialog_id="return_order" dialog_width="480"
            uri="index.php?act=store_return&op=edit&return_id=<?php echo $val['refund_id']; ?>"><i class="icon-edit"></i><p>处理</p></a></span>
        <?php } else { ?>
       <span> <a href="javascript:void(0)" class="btn-orange" nc_type="dialog" dialog_title="<?php echo $lang['nc_view'];?>" dialog_id="return_order" dialog_width="480" uri="index.php?act=store_return&op=view&return_id=<?php echo $val['refund_id']; ?>"><i class="icon-eye-open"></i><p><?php echo $lang['nc_view'];?></p></a></span>
        <?php } ?>
