  ...
  <form id="add_form" action="index.php?act=store_promotion_mansong&op=mansong_save" method="post">
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="hint"><?php echo sprintf($lang['mansong_add_end_time_explain'],date('Y-m-d H:i',$output['end_time']));?></p>
      </dd>
    </dl>
    <dl>
...
$(document).ready(function(){
    ...
    $("#add_form").validate({
        ...
        messages : {
            ...
            rule_count: {
                required: '<i class="icon-exclamation-sign"></i>最少添加一条规则',
                min: '<i class="icon-exclamation-sign"></i>最少添加一条规则'
            }
        }
    });
