  ...
  <div class="top-container">
    <div class="basic-info">
      <dl class="ncsc-seller-info">
        ...
        <dd class="store-validity"><?php echo $lang['store_validity'].$lang['nc_colon'];?><strong><?php echo $output['store_info']['store_end_time_text'];?></strong></dd>
      </dl>
...
与行业相比
  ...
  <div class="seller-cont">
    ...
    <?php /* 交易提醒 ?><div class="container type-a">
      <div class="hd">
    ...
    <?php /* ?><div class="container type-c">
      <div class="hd">
        <h3>销售情况统计</h3>
