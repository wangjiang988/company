...
<div class="ncsc-store-templet">
  <dl class="current-style">
    ...
    <dd><a href="<?php echo urlShop('show_store', 'index', array('store_id' => $output['store_info']['store_id']));?>" target="_blank" class="ncsc-btn"><?php echo $lang['store_theme_homepage'];?></a></dd>
  </dl>
