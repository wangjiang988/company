...
$(function () {
    ...
    $(document).ready(function() {
    	chart = new Highcharts.Chart({
          ...
          allowDecimals: false,
    			title: {
    				text: '<?php echo $lang['stat_goods_flow_tip']; ?>',
    				align: 'high'
    			},
    			labels: {
    				overflow: 'justify'
    		...
    		tooltip: {
    			formatter: function() {
    				return ''+
    					this.series.name +': '+ this.y +' <?php echo $lang['stat_time']; ?>';
    			}
    		},
    		plotOptions: {
    			bar: {
  ...
  <form method="get" action="index.php">
    <table class="search-form">
      ...
      <input type="hidden" name="op" value="goods_flow_statistics" />
      <tr>
...
<script type="text/javascript">
	$(function(){
	    ...
	    $('#week_flow').click(function(){
	    	window.location.href = 'index.php?act=statistics_flow&op=goods_flow_statistics';
		})
		$('#month_flow').click(function(){
	    	window.location.href = 'index.php?act=statistics_flow&op=goods_flow_statistics&type=month';
		})
		$('#year_flow').click(function(){
	    	window.location.href = 'index.php?act=statistics_flow&op=goods_flow_statistics&type=year';
		})
	});
</script>
