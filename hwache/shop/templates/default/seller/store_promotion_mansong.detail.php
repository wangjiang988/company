  ...
  <tbody>
    <tr class="bd-line"><td></td>
      ...
      <td><ul class="ncsc-mansong-rule-list">
          ...
          <li><?php echo $lang['level_price'];?><strong><?php echo $val['price'];?></strong>元，&nbsp;<?php echo $lang['level_discount'];?><strong><?php echo empty($val['discount'])?$lang['text_not_join']:$val['discount'];?></strong>元，&nbsp;<?php if(empty($val['goods_id'])) { ?>
