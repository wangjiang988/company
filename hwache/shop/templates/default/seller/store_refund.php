  ...
  <tbody>
    ...
    <tr class="bd-line" >
        ...
        <td class="w50"><div class="pic-thumb">
            <a href="<?php echo urlShop('goods','index',array('goods_id'=> $val['goods_id']));?>" target="_blank"><img src="<?php echo thumb($val,60);?>"/></a></div></td>
      ...
      <td class="nscs-table-handle"><?php if ($val['seller_state'] == 1) { ?>
    	<span><a href="javascript:void(0)" class="btn-blue" nc_type="dialog" dialog_title="处理" dialog_id="refund_edit" dialog_width="480" uri="index.php?act=store_refund&op=edit&refund_id=<?php echo $val['refund_id']; ?>"><i class="icon-edit"></i><p>处理</p></a></span>
    	<?php } else { ?>
    	<span><a href="javascript:void(0)" class="btn-orange" nc_type="dialog" dialog_title="<?php echo $lang['nc_view'];?>" dialog_id="refund_order" dialog_width="480" uri="index.php?act=store_refund&op=view&refund_id=<?php echo $val['refund_id']; ?>"><i class="icon-eye-open"></i><p><?php echo $lang['nc_view'];?></p></a></span><?php } ?>
       </td>
    </tr>
    <?php } ?>
    <?php } else { ?>
