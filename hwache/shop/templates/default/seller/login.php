...
<div class="ncsc-login-container">
  ...
  <form id="form_login" action="index.php?act=seller_login&op=login" method="post" >
    ...
    <input name="back_url" type="hidden" value="<?php echo $output['back_url'];?>" />
    <div class="input">
      <label>用户名</label>
      <span class="repuired"></span>
      <input name="seller_name" type="text" value="system_seller" autocomplete="off" class="text" autofocus>
      <span class="ico"><i class="icon-user"></i></span> </div>
    <div class="input">
      <label>密码</label>
      <span class="repuired"></span>
      <input name="password" type="password" autocomplete="off" value="123456" class="text">
  ...
  <div class="copyright">© 2014-<?php echo date('Y'); ?></div>
</div>
</body>
</html>
