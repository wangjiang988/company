...
<?php if(!empty($output['bundling_quota']) && $output['bundling_quota']['bl_state'] == 1) { ?>
<?php if(empty($output['list'])) { ?>
<!-- 没有添加活动 -->
<table class="ncsc-table-style ncm-promotion-buy">
  <tbody>
    <tr>
      <td colspan="20" class="norecord"><div class="no-promotion"><i class="zh"></i><span><?php echo $lang['bundling_list_null'];?></span></div></td>
    </tr>
  </tbody>
</table>
<?php } else { ?>
...
<table class="ncsc-table-style ncm-promotion-buy">
  <tbody>
    <tr>
      <td colspan="20" class="norecord"><div class="no-promotion"><i class="zh"></i><span><?php echo $lang['bundling_quota_current_error'];?></span></div></td>
    </tr>
  </tbody>
</table>
<?php }?>
