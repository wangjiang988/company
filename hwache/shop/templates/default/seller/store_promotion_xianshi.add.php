...
<div class="ncsc-form-default">
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="hint"><?php echo sprintf($lang['xianshi_add_start_time_explain'],date('Y-m-d H:i',$output['current_xianshi_quota']['start_time']));?></p>
      </dd>
    </dl>
    <dl>
      ...
      <dd>
        ...
        <p class="hint"><?php echo sprintf($lang['xianshi_add_end_time_explain'],date('Y-m-d H:i',$output['current_xianshi_quota']['end_time']));?></p>
      </dd>
    </dl>
    <?php } ?>
    <dl>
