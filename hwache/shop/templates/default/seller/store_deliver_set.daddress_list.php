...
<table class="ncsc-table-style" >
  <thead>
    <tr>
      ...
      <th class="tl"><?php echo $lang['store_daddress_location'];?></th>
  ...
  <tbody>
    ...
    <tr class="bd-line">
      <td><input type="radio" name="is_default" <?php if ($address['is_default'] == 1) echo 'checked';?> value="<?php echo $address['address_id'];?>">
        <?php echo $lang['store_daddress_default'];?></td>
