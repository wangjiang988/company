    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td>
        	...
        	<br/><a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['nc_ensure_del'];?>','index.php?act=store_voucher&op=templatedel&tid=<?php echo $val['voucher_t_id'];?>');" class="ncsc-btn"><?php echo $lang['nc_del'];?></a>
        	<?php }?>
        </td>
      </tr>
      <?php }?>
