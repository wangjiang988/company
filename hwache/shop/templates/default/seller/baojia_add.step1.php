...
<div class="wrapper_search">
  ...
  <div class="wp_confirm">
    <form method="get">
      ...
      <input type="hidden" name="act" value="baojia_online" />
      ...
      <?php } else {?>
      <input type="hidden" name="act" value="baojia_add" />
      <input type="hidden" name="op" value="add_step_two" />
      <?php }?>
      <input type="hidden" name="class_id" id="class_id" value="" />
      <input type="hidden" name="t_id" id="t_id" value="" />
      <div class="bottom tc">
      <label class="submit-border"><input disabled="disabled" nctype="buttonNextStep" value="下一步，填写车型信息" type="submit" class="submit"style=" width: 200px;" /></label>
      </div>
    </form>
  </div>
</div>
