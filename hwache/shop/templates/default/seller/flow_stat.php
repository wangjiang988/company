...
<form method="get" action="index.php">
  <table class="search-form">
    ...
    <tr>
      <td><a href="javascript:void(0);" class="ncsc-btn-mini" id="week_flow"><?php echo $lang['stat_week_flow']; ?></a><a href="javascript:void(0);" id="month_flow" class="ncsc-btn-mini"><?php echo $lang['stat_month_flow']; ?></a> <a href="javascript:void(0);" id="year_flow" class="ncsc-btn-mini"><?php echo $lang['stat_year_flow']; ?></a></td>
...
<script type="text/javascript">
	$(function(){
	    ...
	    $('#week_flow').click(function(){
	    	window.location.href = 'index.php?act=statistics_flow&op=flow_statistics';
		})
		$('#month_flow').click(function(){
	    	window.location.href = 'index.php?act=statistics_flow&op=flow_statistics&type=month';
		})
		$('#year_flow').click(function(){
	    	window.location.href = 'index.php?act=statistics_flow&op=flow_statistics&type=year';
		})
	});
</script>
