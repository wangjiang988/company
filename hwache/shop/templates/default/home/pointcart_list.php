  ...
  <div class="ncc-main">
    ...
    <table class="ncc-table-style">
      ...
      <tr id="pcart_item_<?php echo $v['pcart_id']; ?>">
        <td></td>
        <td class="w60"><a href="<?php echo urlShop('pointprod', 'pinfo', array('id' => $v['pgoods_id']));?>" target="_blank" class="ncc-goods-thumb"><img src="<?php echo pointprodThumb($v['pgoods_image']); ?>" alt="<?php echo $v['pgoods_name']; ?>"/></a></td>
