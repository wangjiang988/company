...
<div class="left-content">
        ...
        <div class="shop-content">
          ...
          <div class="detail">
            ...
            <ul nc_type="mycarousel" class="jcarousel-skin-tango">
              ...
              <li><a href="<?php echo $g_v['goodsurl'];?>" target="_blank" style=" background-image: url(<?php echo thumb($g_v,240);?>)" title="<?php echo $g_v['goods_name'];?>">&nbsp;</a></li>
              <?php }?>
            </ul>
            <?php }?>
          </div>
  ...
  <ul class="fd-list">
    ...
    <li nc_type="tracerow_<?php echo $v['trace_id']; ?>">
      <dl class="fd-wrap">
        <dt><img src="<?php echo getMemberAvatar($v['trace_memberavatar']);?>"  data-param="{'id':<?php echo $v['trace_memberid'];?>}" nctype="mcard">
