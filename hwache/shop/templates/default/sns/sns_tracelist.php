...
<div id="lazymodule">
  ...
  <ul class="fd-list">
    ...
    <li nc_type="tracerow_<?php echo $v['trace_id']; ?>">
      <dl class="fd-wrap">
        <dt>
          <img src="<?php if ($v['trace_memberavatar']!='') { echo UPLOAD_SITE_URL.'/'.ATTACH_AVATAR.DS.$v['trace_memberavatar']; } else {  echo UPLOAD_SITE_URL.'/'.ATTACH_COMMON.DS.C('default_user_portrait'); } ?>" data-param="{'id':<?php echo $v['trace_memberid'];?>}" nctype="mcard">
