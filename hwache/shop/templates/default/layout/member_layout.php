...
<![endif]-->
<script>
var PROXY_URL = '<?php echo urlencode(SHOP_SITE_URL);?>';
...
<header id="header" class="pngFix">
  <div class="wrapper">
    ...
    <nav>
      <ul>
        <li class="frist"><a <?php if($output['header_menu_sign'] == 'snsindex'){ echo "class='active'";}else{ echo "class='normal'";}?> href="index.php?act=m_index" title="<?php echo $lang['nc_member_path_buyerindex'];?>">首页</a></li>
        <?php /*  //个人主页 ?><li><a <?php if($output['header_menu_sign'] == 'snshome'){ echo "class='active'";}else{ echo "class='normal'";}?> href="index.php?act=member_snshome" title="<?php echo $lang['nc_member_path_myspace'];?>"><?php echo $lang['nc_member_path_myspace'];?></a></li>
        // 好友
        <li><a <?php if($output['header_menu_sign'] == 'friend'){ echo "class='active'";}else{ echo "class='normal'";}?> href="index.php?act=member_snsfriend&op=find" title="<?php echo $lang['nc_member_path_friend'];?>"><?php echo $lang['nc_member_path_friend'];?></a></li><?php */ ?>
        <li><a <?php if($output['header_menu_sign'] == 'order'){ echo "class='active'";}else{ echo "class='normal'";}?> href="index.php?act=m_order" title="订单">订单</a></li>
  ...
  <div class="layout">
    ...
    <div class="sidebar">
      ...
      <div class="business-intro">
        ...
        <ul>
          <li><span><a href="index.php?act=m_order&status=earnest">已支付诚意金</a></span> <i <?php if($output['member_info']['order_nopay'] > 0){ echo "class='yes'";}else{ echo "class='no'";}?>><?php echo $output['member_info']['order_nopay'];?></i></li>
          <li><span><a href="index.php?act=m_order&status=deposit">已支付定金</a></span> <i <?php if($output['member_info']['order_noreceiving'] > 0){ echo "class='yes'";}else{ echo "class='no'";}?>><?php echo $output['member_info']['order_noreceiving'];?></i></li>
          <li><span><a href="index.php?act=m_order&status=execute">订单执行中</a></span> <i <?php if($output['member_info']['order_noeval'] > 0){ echo "class='yes'";}else{ echo "class='no'";}?>><?php echo $output['member_info']['order_noeval'];?></i></li>
        </ul>
      </div>
      <script type="text/javascript">
        // <![CDATA[
