...
<header class="ncsc-head-layout w">
  <div class="wrapper">
    <div class="ncsc-admin">
      ...
      <div class="ncsc-admin-function"><?php /* 前往店铺 ?><a href="<?php echo urlShop('show_store', 'index', array('store_id'=>$_SESSION['store_id']), $output['store_info']['store_domain']);?>" target="_blank" title="前往店铺" ><i class="icon-home"></i></a><?php */ ?><a href="<?php echo urlShop('home', 'message');?>" title="站内消息" class="pr" target="_blank"><i class="icon-envelope-alt"></i><em><?php echo $output['message_num'];?></em></a><a href="<?php echo urlShop('home', 'passwd');?>" title="修改密码" target="_blank"><i class="icon-wrench"></i></a><a href="<?php echo urlShop('seller_logout', 'logout');;?>" title="安全退出"><i class="icon-signout"></i></a></div>
    </div>
