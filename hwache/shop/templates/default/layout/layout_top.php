...
<div class="public-top-layout w">
  <div class="topbar wrapper">
    ...
    <?php if($_SESSION['is_login'] == 1){?>
      ...
      <a href="<?php echo WWW_SITE_URL;?>"  title="<?php echo $lang['homepage'];?>" alt="<?php echo $lang['homepage'];?>"><span><?php echo $GLOBALS['setting_config']['site_name']; ?></span></a>
      <span>[<a href="<?php echo WWW_SITE_URL.'/user/logout';?>"><?php echo $lang['nc_logout'];?></a>]</span>
    <?php }else{?>
    ...
    <?php }?>
        <?php /* ?><span class="seller-login"><a href="<?php echo urlShop('seller_login','show_login');?>" target="_blank" title="登录商家管理中心"><i class="icon-signin"></i>商家管理中心</a></span><?php */ ?>
    </div>
