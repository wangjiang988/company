    ...
    <div class="ncs-goods-main" id="main-nav-holder">
      <div class="ncs-comment">
        <div class="ncs-goods-title-bar">
          <h4><?php echo $lang['goods_index_evaluation'];?></a></h4>
        </div>
      ...
      <div class="nc-s-c-s1">
        ...
        <div class="content">
          <dl class="ncs-comment-goods">
            ...
            <dd class="goods-raty"><?php echo $lang['goods_index_evaluation'].$lang['nc_colon'];?> <span class="raty" data-score="<?php echo $output['goods_evaluate_info']['good_star'];?>"></span> </dd>
          </dl>
        </div>
        <!--S 店铺信息-->
