    ...
    protected function checkLogin(){
        if ($_SESSION['is_login'] !== 1){
            ...
            if ($_GET['inajax']){
                ...
                @header("location: ".WWW_SITE_URL.'/user/login?'.urlencode($ref_url));
            }
            exit;
        }
    }
...
//        $hash_key = $_SESSION['member_id'];
        //写入缓存的数据
//        $cachekey_arr = array('member_name','store_id','member_avatar','member_qq','member_email','member_ww','member_goldnum','member_points', 'available_predeposit','member_snsvisitnum','credit_arr','order_nopay','order_noreceiving','order_noeval','fan_count');
...
class BaseSellerControl extends Control {
    ...
    private function _getMenuList() {
        // 修改的导航菜单，系统原先的在下面注释掉了
        $menu_list = array(
            'goods' => array('name'=>'报价', 'child' => array(
                array('name'=>'报价发布', 'act'=>'baojia_add', 'op'=>'index'),
                array('name'=>'已发布的报价', 'act'=>'store_goods_online', 'op'=>'index'),
                array('name'=>'未完成的报价', 'act'=>'baojia_unfinished', 'op'=>'index'),
                array('name'=>'保险设置', 'act'=>'store_baoxian', 'op'=>'index'),
                array('name'=>'选装件管理', 'act'=>'store_xzj', 'op'=>'index'),
				array('name'=>'刷卡设置', 'act'=>'store_shuaka', 'op'=>'index'),
            ...
            'order' => array('name'=>'订单', 'child' => array(
                array('name'=>'订单管理', 'act'=>'daili_order', 'op'=>'index'),
            ...
            'store' => array('name'=>'经销商', 'child' => array(
                array('name'=>'经销商设置', 'act'=>'store_setting', 'op'=>'store_setting'),
                ...
                array('name'=>'常用文件', 'act'=>'store_files', 'op'=>'index'),
                array('name'=>'服务专员', 'act'=>'fuwuzhuanyuan', 'op'=>'index'),
                array('name'=>'向客户移交的资料', 'act'=>'yijiao', 'op'=>'index'),
            )),
            ...
            'settle' => array('name'=>'结算', 'child' => array(
				/**
                    array('name'=>'待结算', 'act'=>'store_calc', 'op'=>'toCalc'),
					array('name'=>'结算中', 'act'=>'store_calc', 'op'=>'inCalc'),
					array('name'=>'已结算', 'act'=>'store_calc', 'op'=>'endCalc'),**/
					array('name'=>'结算文件', 'act'=>'store_calc', 'op'=>'index'),
