...
define('WWW_SITE_URL', $config['www_site_url']);
define('API_URL',$config['api_site_url']);
...
define('BASE_FILE_PATH',WWW_SITE_URL.'/upload/');
define('BASE_DATA_PATH',BASE_ROOT_PATH.'/data');
define('BASE_UPLOAD_PATH',BASE_DATA_PATH.'/upload');
define('BASE_RESOURCE_PATH',BASE_DATA_PATH.'/resource');
define('BASE_EVIDENCE_PATH',$config['www_site_url'].'/upload/evidence');
...
require_once(BASE_CORE_PATH.'/framework/function/common.php');
