  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a class="current" href="javascript:;"><span>修改通用选装件</span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="table tb-type2">
      <tbody>
        <tr>
          ...
          <td>
            <label><input type="checkbox" value="1" name="front" <?php if($output['xzj']['xzj_front']){ ?>checked="checked"<?php }?> /> 必须前装</label>
          </td>
        </tr>
        <tr>
          <td class="tar">名称<?php echo $lang['nc_colon'];?></td>
          <td>
            <input type="text" class="w300" name="name" value="<?php echo $output['xzj']['xzj_title'];?>" />
          </td>
        </tr>
        <tr>
          <td class="tar">品牌<?php echo $lang['nc_colon'];?></td>
          <td>
            <input type="text" class="w300" name="brand" value="<?php echo $output['xzj']['xzj_brand'];?>" />
          </td>
        </tr>
        <tr>
