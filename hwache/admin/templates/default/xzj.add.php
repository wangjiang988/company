...
<div class="page">
  ...
  <form id="form" method="post">
    ...
    <input type="hidden" name="car_id" value="<?php echo $output['carid'];?>">
    <input type="hidden" name="car_title" value="<?php echo $output['carTitle'];?>">
     <input type="hidden" name="yc" value="1">
    <table class="table tb-type2">
      <tbody>
        <tr>
          <td class="w120 tar">车型品牌<?php echo $lang['nc_colon'];?></td>
          <td><?php echo $output['carTitle'];?></td>
        </tr>
        <!--<tr>
          <td class="tar">是否原厂<?php //echo $lang['nc_colon'];?></td>
          <td>
            <label><input type="checkbox" name="yc" checked="checked" /> 原厂</label>
          </td>
        </tr>-->
        <tr>
          <td class="tar">是否必须前装<?php echo $lang['nc_colon'];?></td>
          <td>
            <label><input type="checkbox" name="front" checked="checked" /> 必须前装</label>
          </td>
        </tr>
        <tr>
        ...
        <!--<tr>
          ...
          <td>
            <input type="text" class="w300" name="brand" value="" disabled="disabled" style="background:#E7E7E7 none;" />
          </td>
        </tr>-->
        <tr>
        ...
        <tr>
          ...
          <td>
            <input type="text" class="w60" name="guide_price" value="" /> 元
          </td>
        </tr>
        <tr>
