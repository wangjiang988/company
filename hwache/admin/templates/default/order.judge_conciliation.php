...
<h4 class="title-weight"><font>平台裁判</font></h4>
<form method="post" action="">
<input type="hidden" name="query" value="1">

<div class="form-group">
    <label class="col-sm-2 control-label"><b style="color:red">*</b>判定结论</label>
    <div class="col-sm-10">
        <label class="radio-inline">
            <input type="radio" name="arbitrate_result"  value="1">裁判售方违约
        </label>
        <label class="radio-inline">
            <input type="radio" name="arbitrate_result"  value="2">裁判客户违约
        </label>
        <?php if($output['order']['order_state']==300):?>
        <label class="radio-inline">
            <input type="radio" name="arbitrate_result"  value="3">客户支付买车担保金违约
        </label>
        <?php endif;?>
    </div>
</div>
...
<?php if($output['order']['order_state']==300):?>
        ...
        <div class="row">
            <div class="col-sm-2">客户加信宝：￥<span><?=$output['order']['user_freeze_jxb'];?></span></div>
            <div class="col-sm-2">已选合计：￥<span><?=$output['order']['user_freeze_jxb'];?></span></div>
        </div>
        <hr/>
        <div class="col-sm-4 cut-off">
            <div class="form-group">
                <label>赔偿售方</label>
                <div class="form-inline">
                    <label><input type="checkbox" name="selectDamage" value="1" checked='checked' disabled>诚意金赔偿￥</label>
                    <input type="text"  class="form-control" name="apology_deposit_to_seller" value="299" disabled>
                </div>
            </div>
        </div>
        <div class="col-sm-4 cut-off">
            <div class="form-group">
                ...
                <div class="form-inline">
                    <label><input type="checkbox" name="selectDamage" value="1" checked='checked' disabled>诚意金赔偿￥</label>
                    <input type="text"  class="form-control" name="apology_deposit_to_hwache" value="200" disabled>
                </div>
            </div>
        </div>
        <div class="col-sm-4 cut-off">
            <div class="form-group">
                <label>退回客户</label>
                <div class="form-inline">
                    <label><input type="checkbox" name="selectDamage" value="1" checked='checked' disabled>退还可用余额￥</label>
                    <input type="text"  class="form-control" name="return_user_available_deposit_from_userjxb" value="<?=$output['order']['user_freeze_jxb']-499;?>" disabled>
                    <input type="hidden"  class="form-control" name="return_user_deposit" value="<?=$output['order']['user_freeze_jxb']-499;?>">
                </div>
            </div>
        </div>
        <br/>
        <div class="row">
            <div class="col-sm-2">售方加信宝：￥<span>499.00</span></div>
            <div class="col-sm-2">已选合计：￥<span>499.00</span></div>
        </div>
        <hr/>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label>退回售方</label>
                <div class="form-inline">
                    <label><input type="checkbox" name="selectDamage" value="1" checked='checked' disabled>退还可提现余额￥</label>
                    <input type="text"  class="form-control" name="return_user_avaiable_from_sellerjxb" value="499" disabled>
                </div>
            </div>
        </div>
            </div>
...
<div class="col-sm-3 cut-off">
    <div class="form-group">
        ...
        <div class="form-inline">
            <label><input type="checkbox" name="selectDamage" value="1">买车担保金赔偿￥</label>
            <input type="text"  class="form-control check_user_price"  high_price="<?=$output['order']['sponsion_price']-$output['baojia_price']['client_hand_price'];?>" name="hwache_deposit_from_userjxb">
        </div>
    </div>
</div>
<div class="col-sm-3 cut-off">
    <div class="form-group">
        ...
        <div class="form-inline">
            ...
            <input type="text"  class="form-control check_user_price" name="return_user_available_deposit_from_userjxb">
        </div>
    </div>
</div>
<div class="col-sm-3">
...
<div class="col-sm-6 cut-off">
    <div class="form-group">
        <label>赔偿客户</label>
        <div class="form-inline">
            <label><input type="checkbox" name="selectDamage" value="user_damage">客户买车其他损失赔偿￥</label>
...
<div class="col-sm-6 cut-off">
    <div class="form-group">
        <label>赔偿平台</label>
        <div class="form-inline">
            <label><input type="checkbox" name="selectDamage" value="hwache_damage">华车平台损失赔偿￥</label>
...
<div class="form-inline text-center">
    <button type="button" class="btn btn-warning" onclick="submit_judge()">提交</button>
