  ...
  <form id="admin_form" method="post" action='index.php?act=admin&op=admin_edit&admin_id=<?php echo $output['admininfo']['admin_id'];?>'>
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td colspan="2" ><label  for="admin_truename">真实姓名:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" id="admin_truename" name="admin_truename" class="txt" value="<?php echo $output['admininfo']['admin_truename']?>"></td>
          <td class="vatop tips"></td>
        </tr>
