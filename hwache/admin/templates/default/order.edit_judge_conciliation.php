...
<div class="form-group">
    ...
    <div class="col-sm-10">
        ...
        <?php if($output['order']['order_state']==203):?>
        <label class="radio-inline">
            ...
            <div class="col-sm-4 cut-off">
                <div class="form-group">
                    ...
                    <div class="form-inline">
                        ...
                        <input type="text"  class="form-control" value="299" disabled>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 cut-off">
            ...
            <div class="col-sm-4 cut-off">
                <div class="form-group">
                    ...
                    <div class="form-inline">
                        ...
                        <input type="text"  class="form-control" value="<?=$output['order']['user_freeze_jxb']-499;?>" disabled>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="form-inline">
                        ...
                        <input type="text"  class="form-control" value="499" disabled>
                    </div>
                </div>
            </div>
        </div>
...
<div class="form-inline text-center">
    <button type="button" class="btn btn-default" onclick="giveup_judge()">放弃本次裁判</button>
...
<script>
    ...
    function giveup_judge()
    {
        layer.confirm('确定放弃本次裁判吗？',{
        btn:['确认','取消'],
        title:'放弃裁判确认'
        }, function(){
            $.ajax({
                type: 'post',
                url:   '/index.php?act=order&op=ajax_giveup_judge_conciliation',
                data : {
                    id:<?=$_GET['id'];?>,
                },
                dataType: 'json',
