    ...
    <form id="finance_form" action="<?=url('seller_finance','save_recharge_ok');?>" method="post" enctype="multipart/form-data">
        ...
        <table class="table tb-type2">
            ...
            <tr class="noborder">
                ...
                <td width="required" colspan="3">
                    汇款方账号：<?=$output['find']['bank_account'];?>
                </td>
            </tr>
            <tr>
                <td class="required" colspan="3">银行到账金额：<?=$output['find']['kefu_confirm_money'];?></td>
            ...
            <tr>
                <td class="required" colspan="3">银行到账时间：
                    <?php
                    echo ($output['find']['kefu_confirm_status'] !=2) ? $output['find']['recharge_confirm_at'] : '';
                    ?> </td>
                <td class="required" colspan="3">&nbsp;</td>
            </tr>
            ...
            <?php
            if($output['find']['kefu_confirm_status'] ==2) {
            ?>
                <tr>
            ...
            <tr class="tfoot">
                <td colspan="15" style="text-align: center;" >
                    ...
                    if($output['find']['kefu_confirm_status']==2) {
                        ?>
                        <input type="button" onclick="saveSubmitType('saves')" class="button button-primary button-small" value="保存" />
                        <input type="button" onclick="saveSubmitType('submits')" class="button button-primary button-small" value="提交补充信息" />
                        <?php } ?>
