...
<div class="page">
    ...
    <form id="seller_form" action="<?=url('seller_finance','save_withdraw');?>" method="post" enctype="multipart/form-data">
        ...
        <table class="table tb-type2">
            ...
            <tr>
                <td class="required" colspan="3">转账报错人：售方</td>
                <td class="required" colspan="3">转账报错时间：<?=$output['find']['created_at'];?></td>
            </tr>
            ...
            <tr class="tfoot">
                <td colspan="15" style="text-align: center;" >
                    <a href="<?=url('seller_finance','withdraw');?>" class="button button-glow button-border button-highlight button-small"> 返回 </a>
                </td>
            </tr>
            </tfoot>
        </table>
