...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <h3 ><a href="<?php echo WWW_SITE_URL.'/cache/car?admin=yeath';?>" style="color:purple;">更新车型缓存</a></h3>
      <h3><a href="<?php echo WWW_SITE_URL.'/cache/car-all?admin=yeath';?>" style="color:purple;">更新前台品牌缓存</a></h3>
      <h3><a href="<?php echo WWW_SITE_URL.'/cache/car-info?admin=yeath';?>" style="color:purple;">更新前台车系缓存</a></h3>
    </div>
  </div>
