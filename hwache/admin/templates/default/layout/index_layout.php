...
<title><?php echo $output['html_title'];?>后台管理中心</title>
<link href="<?php echo ADMIN_TEMPLATES_URL;?>/css/skin_0.css" rel="stylesheet" type="text/css" id="cssfile"/>

<!-- @begin 注释掉之前的jquery版本，改用1.11.3版本-->
<!-- @by wangjiang   -->
<!--<script type="text/javascript" SRC="--><?php //echo RESOURCE_SITE_URL;?><!--/js/jquery.js"></script>-->
<script type="text/javascript" SRC="<?php echo RESOURCE_SITE_URL;?>/js/jquery-1.11.3.min.js"></script>
<!-- @end-->
      ...
      <td colspan="2" height="90" class="mainhd"><div class="layout-header"> <!-- Title/Logo - can use text instead of image -->
          ...
          <div id="topnav" class="top-nav">
            <ul>
              ...
              <li><a href="<?php echo WWW_SITE_URL;?>" target="_blank" title="<?php echo $lang['nc_homepage'];?>"><span><?php echo $lang['nc_homepage'];?></span></a></li>
            </ul>
          </div>
    ...
    <tr>
        <td class="menutd" valign="top" width="161">
            ...
            <div class="copyright">
                ...
                <p><a href="<?php echo C('www_site_url'); ?>" target="_blank"><?php echo C('company'); ?></a></p>
            </div>
        </td>
