...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3><?php echo $lang['nc_ja_message'];?></h3>
    </div>
  </div>
    ...
    <tbody class="noborder">
      ...
      <tr>
        <td><?php if (is_array($output['url'])){ foreach($output['url'] as $k => $v){ ?>
          ...
          <a href="<?php echo $output['url'];?>" class="btns"><span><?php echo isset($lang['nc_back_to_pre_page'])?$lang['nc_back_to_pre_page']:"立即跳转";?></span></a>
          <script type="text/javascript"> window.setTimeout("javascript:location.href='<?php echo $output['url'];?>'", <?php echo $time;?>); </script>
          <?php }else { ?>
          <a href="javascript:history.back()" class="btns"><span><?php echo isset($lang['nc_back_to_pre_page'])?$lang['nc_back_to_pre_page']:"返回";?></span></a>
