    ...
    <table class="table tb-type2">
      <tbody>
          ...
          <td>
            <select name="model" id="model">
              ...
              <option value="<?php echo $k; ?>"
                <?php if($k == $data['model'] ) echo "selected";?>
              ><?php echo $v; ?></option>
              <?php }?>
            </select>
          </td>
        ...
        <tr class="noborder">
          ...
          <td>
            <select name="type" id="type">
              ...
              <option value="<?php echo $k; ?>"
                  <?php if($k == $data['type'] ) echo "selected";?>
              ><?php echo $v; ?></option>
              <?php }?>
            </select>
          </td>
        ...
        <tr class="noborder" id="setting_tr" style="display:none;">
          ...
          <td><textarea name="setting" rows="6" ><?=$data['setting']?></textarea></td>
        ...
        <tr class="noborder">
          ...
          <td><input type="text" name="sort" value="<?=$data['sort']?>" value="255"></td>
          <td class="tips"></td>
        </tr>
        <tr class="noborder">
      ...
      <tfoot>
        <tr class="tfoot">
          <td colspan="15"><a href="JavaScript:void(0);" class="btn" id="submitBtn"><span>修改</span></a></td>
        </tr>
      </tfoot>
    </table>
  </form>
