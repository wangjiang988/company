    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                ...
                <li><a href="JavaScript:void(0);" class="current"><span>查看<em class="red">免激活</em>代金券组</span></a></li>
            </ul>
        </div>
    </div>
            ...
            <tr>
                ...
                <td class="vatop rowform">
                    ...
                    if($group['use_collateral'] && $group['use_sincerity']){
                        echo '诚意金 ￥'.$group['sincerity_money'].'<a href="'.$group['ignore_collateral_temp'].'">查看设计模板</a>';
                    }else{
                        if(empty($group['use_collateral'])){
                            echo '诚意金 ￥'.$group['sincerity_money'].'<a href="'.$group['ignore_collateral_temp'].'">查看设计模板</a>';
                        }else{
                            echo '买车担保金余款 ￥'.$group['collateral_money'].'<a href="'.$group['ignore_sincerity_temp'].'">查看设计模板</a>';
                        }
                    }
                    ?>
                </td>
