...
<div class="page">
        ...
        <table class="tb-type1 noborder search" style="width:100%;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="reward_type">
                        <option value="">  --不限--  </option>
                        <option value="2" <?=isSelected([$search['reward_type'],'==',2],'select')?> >有</option>
                        <option value="1" <?=isSelected([$search['reward_type'],'==',1],'select')?>>无</option>
                    </select>
            ...
            <tr>
                ...
                <td>
                    ...
                    <label for="activated_code">激活码</label>
                    <input type="text" value="<?=$search['activated_code'];?>" name="activated_code" class="txt">
                </td>
            </tr>

            <tr>
                <th><label for="seller_jiaxb">投放区域</label></th>
                <td>
                    ...
                    <label for="seller_jiaxb">投放时间</label>
                    ...
                    <div style="float:right; text-align:left; width:auto;">
                        ...
                        <a href="<?=url('hc_vouchers','release',['activated'=>1])?>" class="button button-primary button-small">重置</a>
                        <a href="<?=url('hc_vouchers','exportRelease',$output['uri'])?>" class="button button-primary button-small">导出</a>
                    </div>
                </td>
            </tr>
            </tbody>
    ...
    <table class="table tb-type2">
        ...
        <tr class="thead">
            ...
            <th class="align-center">推广奖励</th>
            <th class="align-center">投放条数</th>
            <th>投放对象</th>
            <th>投放区域</th>
            <th>投放时间</th>
            <th>投放状态</th>
        ...
        <?php if(!empty($output['list']) && is_array($output['list'])){ ?>
            <?php foreach($output['list'] as $k => $v){ ?>
                <tr class="hover">
                    ...
                    <td><?php
                       echo empty($v['release_total_num'])?'不限':$v['release_total_num'];
                       ?></td>
                    <td class="nowrap align-center">
                        <?php
                        echo getReleaseUse($v['id']);
                        ?>
                    </td>
                    <td>
                        <?php
