  ...
  <form id="goods_class_form" enctype="multipart/form-data" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" name="gc_name" id="gc_name" maxlength="200" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr class="noborder">
            <td colspan="2" class="required"><label class="validation" for="vehicle_model"><?php echo $lang['goods_class_vehicle_model'];?>:</label></td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform"><input type="text" value="" name="vehicle_model" id="vehicle_model" maxlength="200" class="txt"></td>
            <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2"><label for="detail_img"><?php echo '详情图片';?>:</label></td>
        </tr>
        <tr class="noborder">
            ...
            <td class="vatop tips"><?php echo '建议用300px * 300px';?></td>
        </tr>
        <tr>
