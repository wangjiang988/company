...
<div class="page">
  ...
  <form id="form" method="post">
    ...
    <input type="hidden" name="id" value="<?php echo $output['baoxian']['id'] ?>" />
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <input type="text" class="w300" name="title" value="<?php echo $output['baoxian']['baoxian_name'] ?>" />
          </td>
        </tr>
        ...
        <tr>
          ...
          <?php foreach ($output['zhuxian'] as $key => $value): ?>
            <option value="<?php echo $key ?>" <?php if ($output['baoxian']['zhuxian']==$key): ?>
              selected="selected"
