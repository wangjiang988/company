    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr>
          ...
          <td>
            <input type="text" class="w300" name="title" value="<?php echo $output['zengpin']['title']; ?>" />
          </td>
        </tr>
        <!--<tr>
          <td class="tar">价值<?php echo $lang['nc_colon'];?></td>
          <td>
            <input type="text" class="w300" name="price" value="<?php echo $output['zengpin']['title']; ?>" /> 元
          </td>
        </tr>
        <tr>
          ...
          <td><select name="brand_id" id="brand_id">
              ...
              <option <?php if($output['zengpin']['brand_id'] == $v['gc_id']){ ?>selected='selected'<?php } ?> value="<?php echo $v['gc_id'];?>"><?php echo $v['gc_name'];?></option>
              <?php } ?>
              <?php } ?>
            </select></td>
        </tr>-->
...
<!--          <td>-->
<!--            <textarea name="beizhu" id="" cols="30" rows="10">--><?php //echo $output['zengpin']['beizhu']; ?><!--</textarea>-->
<!--          </td>-->
<!--        </tr>-->
      </tbody>
      <tfoot>
