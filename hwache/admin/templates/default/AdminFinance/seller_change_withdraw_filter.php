...
<div class="page finance">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                <li><a  href="index.php?act=admin_finance&op=seller_withdraw_filter"><span>售方提现申请拦截条件设定</span></a></li>
    ...
    <div class="container">
        ...
        <div class="info footer">
            ...
            <a href="index.php?act=admin_finance&op=seller_add_withdraw_filter"   class="ml-50 font-14" >添加条件</a>
            <a href="index.php?act=admin_finance&op=seller_change_withdraw_filter_history" class="ml-20 font-14">查看操作记录</a>
        </div>
...
<script type="text/javascript">
    ...
    function confirm_form() {
        ...
        parent.layer.confirm('确定提交拦截条件吗？', {
            ...
            url  = 'index.php?act=admin_finance&op=seller_change_withdraw_filter'
