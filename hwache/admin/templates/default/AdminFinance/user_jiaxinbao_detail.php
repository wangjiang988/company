...
<div class="page finance">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                <li><a href="index.php?act=admin_finance&op=user_jiaxinbao"><span>用户加信宝</span></a></li>
    ...
    <div class="container">
       <!-- <div class="big_title">
        ...
        <form id="search_form">
            ...
            <input type="hidden" name="op"  value="user_jiaxinbao_detail">
        ...
        <div class="ml50 content">
            ...
            <div class="pure-g line">
                ...
                <div class="pure-u-1-3">
                    ...
                    <a href="index.php?act=admin_finance&op=user_jiaxinbao_detail&id=<?=$_GET['id']?>" class="button">重置</a>
...
<script type="text/javascript">
    ...
    function show_detail(order_id){
        parent.layer.open({
            ...
            area: ['600px', '500px'], //宽高
            content: "index.php?act=admin_finance&op=account_ajax_get_jiaxinbao_detail&role=1&order_id="+order_id
        });
    }
</script>
