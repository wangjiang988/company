...
<div class="page finance">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                <li><a class="current"><span>售方加信宝</span></a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="container">
        <div class="big_title">
            所有售方冻结余额总计：￥<span id="total_freeze_deposit"><?=$sum_freeze_deposit?></span>
        </div>
        <form id="search_form">
            <input type="hidden" name="act"  value="admin_finance">
            <input type="hidden" name="op"  value="seller_jiaxinbao">
        ...
        <div class="ml50 content">
            <div class="pure-g line">
                <div class="pure-u-1-3">
                    售方用户名：<input type="text" name="member_name" value="<?=$_GET['member_name']?>">
                </div>
                <div class="pure-u-1-3">
                    售方手机：<input type="text" name="seller_phone" value="<?=$_GET['seller_phone']?>">
                </div>
                <div class="pure-u-1-3">
            ...
            <div class="pure-g line">
                ...
                <div class="pure-u-1-3">
                    ...
                    <a href="index.php?act=admin_finance&op=seller_jiaxinbao" class="button">重置</a>
                ...
                <?php if(!empty($output['list']) && is_array($output['list'])){ ?>
                    <?php foreach($output['list'] as $k => $v){ ?>
                        <tr class="hover">
                            ...
                            <td><?php echo $v['seller_phone']?></td>
                            <td>￥ <?php echo $v['freeze_deposit']? $v['freeze_deposit']:0; ?></td>
                            <td><a href="javascript:void(0);" onclick="show_detail(<?=$v['member_id'];?>)">查看</a></td>
                        </tr>
                    <?php } ?>
                <?php }else { ?>
...
<script type="text/javascript">
    ...
    function show_detail(id){
        location.href='index.php?act=admin_finance&op=seller_jiaxinbao_detail&id='+id;
    }
</script>
